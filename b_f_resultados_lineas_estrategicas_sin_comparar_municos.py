...
async def descarga(datos: Request, token: str =  Depends(oauth2_scheme_2)):
    ...
    #try:
        ...
        #logged_user = ModelUser.loguin(db, user)
            ...
            dato = mejor_unidad_obj2(datos, link, ruta, 5000)
            return dato
...
if __name__ == "__main__":
     config = uvicorn.Config("b_f_resultados_lineas_estrategicas_sin_comparar_municos:app", port=PUERTO+157, host = IP, log_level="info", reload=True)
