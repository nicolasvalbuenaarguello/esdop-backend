...
@router.post("/mapa_alertas_division")
async def guardar(datos: Request, token: str =  Depends(oauth2_scheme_2)):
    ...
    # # link = "C:/inetpub/wwwroot/pagina_de_dirop/dociments/boletin/"#producci
        ...
        documento_inf  = info_mapa_division(contents)


        dato={
            "info_mapa":documento_inf[0]
        }
        # print(dato)
        # print("guardar evento")
        return dato
@router.post("/mapa_alertas_fecha")
async def guardar(datos: Request, token: str =  Depends(oauth2_scheme_2)):
    ...
    # # link = "C:/inetpub/wwwroot/pagina_de_dirop/dociments/boletin/"#producci
        ...
        # comprecion de archivos 
        documento_inf  = info_mapa_fecha(contents)
...
async def guardar(datos: Request, token: str =  Depends(oauth2_scheme_2)):
    ...
    # # link = "C:/inetpub/wwwroot/pagina_de_dirop/dociments/boletin/"#producci
        ...
        # comprecion de archivos 
        documento_inf  = info_mapa(contents)
...
async def guardar(datos: Request, token: str =  Depends(oauth2_scheme_2)):
    ...
    # # link = "C:/inetpub/wwwroot/pagina_de_dirop/dociments/boletin/"#producci
        ...
        # comprecion de archivos 
        documento_inf  = info_alertas_filtro(contents)




        dato={
            "alertas_filtro":documento_inf[0],

            "alertas_filtro_INFO" :documento_inf[1],
...
if __name__ == "__main__":
     config = uvicorn.Config("a_b_planilla:app", port=PUERTO+34, host = IP, log_level="info", reload=True)
