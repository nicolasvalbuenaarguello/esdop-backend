...
async def leer_orden(input: Request, token: str =  Depends(oauth2_scheme_2)):
    ...
    # else:
            ...
            dato={
                 "ordenes_sin_asignar":documento_inf[0],
                 "alertas":documento_inf[1],
             }
...
if __name__ == "__main__":
     config = uvicorn.Config("ordenes_sejec_leer_asignar:app", port=PUERTO+44, host = IP, log_level="info", reload=True)
