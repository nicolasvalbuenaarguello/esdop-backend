        ...
        if self.fondo_pagina == "SI":
            if self.tipo =="mapa":
                ...
                if self.unidad_png == "DIV01":
                    ...
                    self.image(self.mapa,-28,-36,206,282)
                    

                elif self.unidad_png == "DIV04":
                   
                    self.image(self.mapa,-25.5,-21,189.7,258)
                    ...
                    self.image(self.mapa,-34,-30.5,206,277)
                ...
                elif self.unidad_png == "FUTCO" or self.unidad_png == "FUTOM":
                    
                    self.image(self.mapa,-8,-32,176,268)
                    #pdf.image(mapa,-44,-149,315,476)
                    
                    
                elif self.unidad_png == "CAUCA":
                    
                    self.image(self.mapa,-22,-39,223,300)
                                        
                elif self.unidad_png == "VALLE DEL CAUCA":
                    
                    self.image(self.mapa,-25,-53,209,283)
                                        
                elif self.unidad_png == "NARIÑO":
                    
                    self.image(self.mapa,-31,-57,238,322)
                                        
                elif self.unidad_png == "ANTIOQUIA":
                    
                    self.image(self.mapa,-35.5,-63.5,246.5,332.5)
                                        
                elif self.unidad_png == "AMAZONAS":
                    
                    self.image(self.mapa,-37.5,-67,250,336)
                                                            
                elif self.unidad_png == "ARAUCA":
                    
                    self.image(self.mapa,-37.5,-76,250,336.5)
                                                                      
                elif self.unidad_png == "BOLÍVAR":
                    
                    self.image(self.mapa,-11,-40,221.5,294.5)
                    
                else:
                    
                    #self.image(maself.mapapa,-59.5,-59,229,310)
                    self.image(self.mapa,-52,-54,227,309)
                ...
                if self.unidad_png == "CAUCA" or self.unidad_png == "VALLE DEL CAUCA" or self.unidad_png == "NARIÑO" or self.unidad_png == "ANTIOQUIA"  or self.unidad_png == "AMAZONAS" or self.unidad_png == "ARAUCA" or self.unidad_png == "BOLÍVAR"  :
                    self.text(200, 18, self.titulo)
                    # fecha = strftime(self.fecha, '%y')
                    self.set_text_color(40,40,40)
                    self.set_font('Arial Black', '', 12)
                    self.text(200, 23.5, self.fecha_titulo)
