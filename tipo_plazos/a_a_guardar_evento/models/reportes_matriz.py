...
class PDF(FPDF):
    ...
    def header(self):
        ...
        if self.fondo_pagina == "SI":
            if self.tipo == "ESTADISTICA":
                
                self.image(imagen,10,9,16,19)
                self.image(self.qr,330,5.5,24,24)
                ...
                self.cell(10,5,"No.",1,0, 'L',True)
                self.cell(50,5,"DEPENDENCIA",1,0, 'L',True)
                self.cell(80,5,"FUNCIONARIO",1,0, 'L',True)
                self.cell(40,5,"ORFEO",1,0, 'L',True)
                self.cell(40,5,"FECHA CUMPLIENTO",1,0, 'L',True)
                self.cell(35,5,"DIAS VENCIDOS",1,0, 'L',True)
                self.cell(85,5,"ASUNTO",1,0, 'L',True)
                posicion_final = self.get_y()

                self.set_line_width(0.5)
                self.set_draw_color(130, 130, 130)   
                self.line(10, posicion_final, 350, posicion_final)
                self.line(10, posicion_final+5, 350, posicion_final+5)
    ...
    def footer(self):
        ...
        if self.pie_pagina =="SI":
            ...
            self.text(10, 212, 'Fuente: Evaluación y Seguimiento')
