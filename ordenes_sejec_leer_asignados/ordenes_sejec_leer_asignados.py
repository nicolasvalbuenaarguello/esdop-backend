...
async def guarda_datos(input: Request, token: str =  Depends(oauth2_scheme_2)):
    ...
    # else:
            ...
            direcion_plazo_fina =  direcion_plazo.replace("/plazos_sejec/creados/", "")
            ...
            try:
                ...
                for x in contenido:
                    ...
                    directorio_doc = "C:/Users/nicolas.valbuena/Documents/documentos_serve_jemop/plazos_sejec/asignados/" + x
                    shutil.copy(dirercion_archvios_2, directorio_doc)

                    documento_eliminar = [x]
                    directorio_doc_eliminar = "C:/Users/nicolas.valbuena/Documents/documentos_serve_jemop/plazos_sejec/creados/"
...
async def leer_orden(input: Request, token: str =  Depends(oauth2_scheme_2)):
    ...
    # else:
            ...
            contents = await input.form()
            documento_inf  = numero_orden_select(contents)
...
if __name__ == "__main__":
     config = uvicorn.Config("ordenes_sejec_leer_asignados:app", port=PUERTO+45, host = IP, log_level="info", reload=True)
