...
from tipo_docker.b_f_resultados_lineas_estrategicas_sin_comparar_municos.models.conexion_pos import Databa_bases
from tipo_docker.z_z_z_funtions.funciones import *
from tipo_docker.b_f_resultados_lineas_estrategicas_sin_comparar_municos.models.funtions.componest.tablas import *
...
class Calculo_Spoa:
    def __init__(self, filtro):
            ...
            if filtro[2] != "" and filtro[2] != "---":
                obj_2  = validar_indicador_unidad(json, json_ruta_br, filtro[2])
            elif filtro[0] != "" and filtro[0] != "-":

                obj_2  = validar_indicador_unidad(json, json_ruta, filtro[0])
            self.obj_2 = obj_2[0]
            self.text  = obj_2[1]
            self.enemigo  = obj_2[2]
            if  self.obj_2 == []:
                self.obj_2 = ['SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI']  
    ...
    def resultados_resaltantes_pdf(self, fecha_inicial_u_l, fecha_final_u_l, filtro, pdf, dato):
        ...
        posicion_inicial =0
        posicion_inicial = cuadro_menores_edad(pdf, res_calculo[0], self.obj_2, self.text, self.enemigo)
        ...
        posicion_inicial_rme = cuadro_enemigo_afectaciones(pdf, posicion_inicial, datos_res, self.obj_2, self.text, self.enemigo )
        ...
        #posicion = cuadro_afectaciones_tropas_combate (pdf, posicion_inicial_rme, datos_res_afectaciones, self.obj_2, self.text, self.enemigo )
        ...
        if res_calculo[7] or res_calculo[8] or res_calculo[9]  or res_calculo[10] :
            ...
            pdf.set_text_color(0, 0, 0)
            #pdf.text(pos_vert[0], pos, "AFECTACIÓN A LA CAPACIDAD ARMADA DE LA AMENAZA" )
            pdf.ln(-10)
            pdf.cell(pos_vert)
            pdf.multi_cell(100, 5, "AFECTACIÓN A LA CAPACIDAD ARMADA DE LA AMENAZA" , 0, 'L', False)
            pos = pos + 6
