            ...
            for x in data:
                for y in data[x]:
                    if y['UNIDAD'] == unidad:
                        ...
                        text.append(y['TEXT'])
                        enemigo.append(y['ENEMIGO_BD'])
        return [obj_2, text, enemigo]
...
def cuadro_men_res(pdf, datos_res, enemigo, gao, gao_1, gao_2):
    ...
    rme_resul_2 = formato_numero(rme_resul)

    pdf.ln(5)
    pdf.cell(-5)
    pdf.cell(33,5,str(enemigo),1,0, 'L',True)
    pdf.cell(17,5,str(rme_resul_2),1,0, 'C',True)
...
def cuadro_afect_enemigo(pdf, datos_res, enemigo, gao, gao_1, gao_2):
    ...
    return [5, pres_2, some_2, capt_2, mdom_2]
...
def cuadro_afectaciones_tropas(pdf, datos_res, enemigo, gao, gao_1, gao_2):
    ...
    if total != "-":
        ...
        pdf.cell(30,5,str(enemigo),1,0, 'C',True)
        pdf.cell(19,5,str(ases),1,0, 'C',True)
        pdf.cell(19,5,str(heridos),1,0, 'C',True)
        pdf.cell(19,5,str(total),1,0, 'C',True)
...
def cuadro_menores_edad(pdf, datos_res, obj_2, text, enemigo):
    ...
    pdf.set_font('Arial', 'B', 10)
    pdf.cell(-5)
    pdf.cell(33,5,"ENEMIGO",1,0, 'C',True)
    pdf.cell(17,5,"CANT.",1,0, 'C',True)
    ...
    enemigo_eval = ''
    rme_resul = 0
    while i < min(len(obj_2),len(enemigo),len(text)):
            if obj_2[i] == 'SI':
                if enemigo_eval != enemigo[i] and enemigo[i] != 'TOTAL': 

                    
                    posi = cuadro_men_res(pdf, datos_res, text[i],enemigo[i], enemigo[i], enemigo[i])
                    posicion = posi[0] + posicion
                    rme_resul = posi[1] + rme_resul
                    enemigo_eval = enemigo[i]
    ...
    pdf.ln(5)
    pdf.cell(-5)
    pdf.cell(33,5,"TOTAL",1,0, 'C',True)
    pdf.cell(17,5,rme_resul,1,0, 'C',True)
    posicion = posicion + 5
    pdf.ln(5)
...
def cuadro_enemigo_afectaciones(pdf, posicion_inicial, datos_res, obj_2, text, enemigo):
    ...
    pdf.cell(30,5,"ENEMIGO",1,0, 'C',True)
    pdf.cell(19,5,"PRE.VOL",1,0, 'C',True)
    pdf.cell(19,5,"SOME.",1,0, 'C',True)
    pdf.cell(19,5,"CAPT.",1,0, 'C',True)
    pdf.cell(19,5,"MDOM",1,0, 'C',True)
    pdf.cell(19,5,"TOTAL",1,0, 'C',True)
    posicion = 5 + posicion
    pdf.set_font('Arial', '', 9)
    ...
    while i < min(len(obj_2),len(enemigo),len(text)):
            if obj_2[i] == 'SI':
                if enemigo_eval != enemigo[i] and enemigo[i] != 'TOTAL': 
                    posi = cuadro_afect_enemigo(pdf, datos_res, text[i],enemigo[i], enemigo[i], enemigo[i])
                    posicion = posi[0] + posicion
                    
                    pres_2 = posi[1] + pres_2
                    some_2 = posi[2] + some_2
                    capt_2 = posi[3] + capt_2
                    mdom_2 = posi[4] + mdom_2
 
                    enemigo_eval = enemigo[i]

            i += 1
    total_2 = pres_2 + some_2 + capt_2 + mdom_2
    pres_2 = formato_numero(pres_2)
    some_2 = formato_numero(some_2)
    capt_2 = formato_numero(capt_2)
    mdom_2 = formato_numero(mdom_2)
    total_2 = formato_numero(total_2)

    pdf.set_font('Arial', 'B', 10)
    pdf.ln (5)
    pdf.cell(49)
    pdf.cell(30,5,"TOTAL",1,0, 'C',False)
    pdf.cell(19,5,str(pres_2),1,0, 'C',False)
    pdf.cell(19,5,str(some_2),1,0, 'C',False)
    pdf.cell(19,5,str(capt_2),1,0, 'C',False)
    pdf.cell(19,5,str(mdom_2),1,0, 'C',False)
    pdf.cell(19,5,str(total_2),1,0, 'C',False)
    posicion = 5 + posicion
    pdf.ln (5)
...
def cuadro_afectaciones_tropas_combate (pdf, posicion_inicial, datos_res, obj_2, text, enemigo ):
    ...
    if total != "-":
        ...
        pdf.cell(30,5,"ENEMIGO",1,0, 'C',True)
        pdf.cell(19,5,"ASES.",1,0, 'C',True)
        pdf.cell(19,5,"HERI.",1,0, 'C',True)
        pdf.cell(19,5,"TOTAL",1,0, 'C',True)
        posicion = posicion + 5
        pdf.set_font('Arial', '', 9)
        ...
        posicion = posi + posicion
        posi = cuadro_afectaciones_tropas(pdf, datos_res, "FARC", "FARC", "FARC", "FARC")
        posicion = posi + posicion
        ...
        posicion = posi + posicion
        posi = cuadro_afectaciones_tropas(pdf, datos_res, "GAO-CS", "GAO COMUNEROS DEL SUR","GAO COMUNEROS DEL SUR","GAO COMUNEROS DEL SUR")
        posicion = posi + posicion
        ...
        posicion = posi + posicion
        posi = cuadro_afectaciones_tropas(pdf, datos_res, "OTROS","BACRIM","EPL","NO APLICA")
        posicion = posi + posicion
        ...
        pdf.cell(19,5,str(asesinados),1,0, 'C',True)
        pdf.cell(19,5,str(heridos),1,0, 'C',True)
        pdf.cell(19,5,str(total),1,0, 'C',True)
        posicion = 5 + posicion
        pdf.ln (5)
