...
from tipo_docker.k_c_boletin_mapa_div_comparativo.models.funtions.pdf.boletin_coe import *
#Funcion de resultados nueva ayuda

def a_w_boletin_mapa_div_comparativo_div(datos, link, ruta, puerto):


    nombre_carpeta = "div_comparativo{}/".format(puerto)
