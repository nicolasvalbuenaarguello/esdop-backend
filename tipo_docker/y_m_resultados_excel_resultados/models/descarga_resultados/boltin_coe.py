...
from tipo_docker.y_m_resultados_excel_resultados.models.funtions.pdf.boletin_coe import *
#Funcion de resultados nueva ayuda

def archivo_plano_excel_excel(datos, link, ruta, puerto):

    nombre_carpeta = "archivo_plano_excel_excel{}/".format(puerto)
