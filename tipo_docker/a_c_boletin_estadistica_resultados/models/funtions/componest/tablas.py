...
def cabecera_tabla_dinamica(pdf, text, ln, cell):
    ...
    pdf.ln(ln)
    pdf.cell(cell)
    pdf.cell(155,5,text,1,0, 'C',True)
    ...
    pdf.cell(35,5,"INDICADOR",1,0, 'C',True)
...
def resultados_tabla_dinamica(pdf, datos_res_act, text, suma, unidad, cell):
    ...
    pdf.cell(35,5,res[0],1,0, 'R',False)
    pdf.cell(35,5,unidad,1,0, 'C',False)
    pdf.ln()
...
def separador_boletin_tabla_resultados(pdf,cell, text):
    ...
    pdf.set_text_color(255,255,255)
    pdf.set_font('Arial', 'B', 12)
    pdf.cell(155,6,text,1,0, 'C',True)
    pdf.ln()
