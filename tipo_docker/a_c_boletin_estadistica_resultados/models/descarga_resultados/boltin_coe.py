...
from tipo_docker.a_c_boletin_estadistica_resultados.models.funtions.pdf.boletin_coe import *
#Funcion de resultados nueva ayuda

def boletin_coe_consejos(datos, link, ruta, puerto):

    
    nombre_carpeta = "estadistica_consejos{}/".format(puerto)
    ...
    direcion = pdf_boletin_resultados(fecha_primer_lapso_inicial, fecha_ultimo_lapso_inicial, filtros, dirercion_archvios, nombre_carpeta) 
