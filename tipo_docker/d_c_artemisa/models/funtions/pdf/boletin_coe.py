...
from tipo_docker.d_c_artemisa.models.estadistica.estadistica_boletin_coe import *
#Funcion para la creacion del reporte de narcotrafico
def artemisa(fecha_inicial_u_l, fecha_final_u_l, filtro, dirercion_archvios, nombre_carpeta):
    ...
    img_qr =  "C:/Users/nicolas.valbuena/Documents/programacion 2023/server/tipo_docker/d_c_artemisa/models/qr_img"
...
#--------
    ...
    # fechas en el titulo
    resultado = Calculo_Spoa()
    resultado.resultados_artemisa_boletin(fecha_inicial_u_l, fecha_final_u_l, filtro, pdf)
