...
from tipo_docker.d_c_artemisa.models.funtions.pdf.boletin_coe import *

#Funcion de resultados nueva ayuda

def boletin_artemisa(datos, link, ruta, puerto):

        
    nombre_carpeta = "artemisa{}/".format(puerto)
    ...
    direcion = artemisa(fecha_primer_lapso_inicial, fecha_ultimo_lapso_inicial, filtros, dirercion_archvios, nombre_carpeta) 
