...
from tipo_docker.e_c_boletin_estadistica_artemisa_comp.models.conexion_pos import Databa_bases
from tipo_docker.z_z_z_funtions.funciones import *
from tipo_docker.e_c_boletin_estadistica_artemisa_comp.models.funtions.componest.tablas import *
from tipo_docker.e_c_boletin_estadistica_artemisa_comp.maps.funciones.mapa_filtro import *
...
class Calculo_Spoa:
    ...
    def resultados_artemisas_boletin_comp_resultados(self, pdf, fecha_inicial_u_l, fecha_final_u_l, fecha_inicial_p_l, fecha_final_p_l, filtro, anio_act, anio_ant, fecha_titulo, fecha_titulo_dos):
        ...
        encabezado_tabla_resultados_mapa_compa(pdf, "RESULTADOS LOE AMAZONIA", anio_act, anio_ant)
        pdf.ln(10)
        valor_ant = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo_ante, 30,  "SI") #funcion para filtar el spoa
        valor_act = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 30,  "SI") #funcion para filtar el spoa
        tabla_resultados_con_mapa_comp(pdf,"Capturas LOE Amazonía", valor_ant[0], valor_act[0], "Personas", 18, 1)
        pdf.ln()
        tabla_resultados_con_mapa_comp(pdf,"Plantulas Sembradas",res_calculo_ante[31], res_calculo[31], "Unidades", 18, 1)
        pdf.ln()
        tabla_resultados_con_mapa_comp(pdf,"Incautacion Madera m3",res_calculo_ante[32], res_calculo[32], "Metros Cubicos", 18, 1)
        pdf.ln()
        tabla_resultados_con_mapa_comp(pdf,"Animales Incautados",res_calculo_ante[63], res_calculo[63], "Unidades", 18, 1)
        pdf.ln()
