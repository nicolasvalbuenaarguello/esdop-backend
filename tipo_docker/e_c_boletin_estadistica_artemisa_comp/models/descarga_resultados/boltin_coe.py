...
from tipo_docker.e_c_boletin_estadistica_artemisa_comp.models.funtions.pdf.boletin_coe import *
#Funcion de resultados nueva ayuda

def boletin_coe_artemisa_comparativo(datos, link, ruta,puerto):

    nombre_carpeta = "artemisa_comparatico{}/".format(puerto)
    ...
    direcion = boletin_estadistica_artemisa_comp_boletin(fecha_primer_lapso_inicial, fecha_ultimo_lapso_inicial, fecha_primer_lapso_final, fecha_ultimo_lapso_final, filtros, dirercion_archvios, nombre_carpeta)
