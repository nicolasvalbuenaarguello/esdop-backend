...
from tipo_docker.e_c_boletin_estadistica_artemisa_comp.models.estadistica.estadistica_boletin_coe import *
...
#funcion para crear la estadistica boletin_estadistica_contrabando_comp
def boletin_estadistica_artemisa_comp_boletin(fecha_inicial_u_l, fecha_final_u_l, fecha_inicial_p_l, fecha_final_p_l, filtro, dirercion_archvios, nombre_carpeta):
    ...
    fecha_titulo = str(fecha_titulo) + " ("+ str(fechas_inicial[2]) + " - " + str(fechas_final[2]) + ")"



    img_qr =  "C:/Users/nicolas.valbuena/Documents/programacion 2023/server/tipo_docker/e_c_boletin_estadistica_artemisa_comp/models/img_qr"
    ...
    if  filtro[4] == "lugar":
        ...
        if titulo != "":
            ...
            nombre_doc = titulo
    # fechas en el titulo
    resultados = Calculo_Spoa()
    resultados.resultados_artemisas_boletin_comp_resultados(pdf, fecha_inicial_u_l, fecha_final_u_l, fecha_inicial_p_l, fecha_final_p_l, filtro, fechas_final[2], fechas_inicial[2],fecha_titulo, fecha_titulo_dos)
