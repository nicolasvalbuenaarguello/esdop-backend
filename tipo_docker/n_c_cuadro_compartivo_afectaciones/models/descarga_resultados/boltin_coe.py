...
from tipo_docker.n_c_cuadro_compartivo_afectaciones.models.funtions.pdf.boletin_coe import *
#Funcion de resultados nueva ayuda

def cuadro_compartivo_afectaciones_v(datos, link, ruta,puerto):

    nombre_carpeta = "cuadro_compartivo_afectaciones{}/".format(puerto)
    ...
    direcion = cuadro_compartivo_afectaciones(fecha_primer_lapso_inicial, fecha_ultimo_lapso_inicial, fecha_primer_lapso_final, fecha_ultimo_lapso_final, filtros, dirercion_archvios,nombre_carpeta)
