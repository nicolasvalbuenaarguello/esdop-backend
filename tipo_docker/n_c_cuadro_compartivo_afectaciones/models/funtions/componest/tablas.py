...
def cuadro_heridos_asesinados_comparativos(pdf, datos, filtro):
    ...
    pdf.ln(30)
    pdf.cell(-5)
    pdf.cell(159.5,10,"AFECTACIONES POR ACCIÓN DIRECTA DEL ENEMIGO",1,0, 'C',True)
    ...
    x = (56,11,11,12.5,11,11,12.5,11,11,12.5)
    ...
    pdf.cell(162)
    pdf.set_font('Arial', 'B', 14)
    pdf.cell(157.5,10,"AFECTACIONES POR ACCIÓN DIRECTA DEL ENEMIGO",1,0, 'C',True)
    pdf.set_font('Arial', 'B', 10)
    ...
    celda_afectaciones(pdf, 10, 162, text, rango, id)
    ...
    x = (54,11,11,12.5,11,11,12.5,11,11,12.5)
    y= (10,10,10,10,10,10,10,10,10,10)
    rango =10
    a = ("L","C","C","C","C","C","C","C","C","C") 
    fill = (False, False, False, True, False, False, True, False, False, True)
    ...
    no_aplica = calcular_comparativo_res(datos, "NO APLICA", 7, 18, -1)
    if no_aplica[6] != "-" or no_aplica[7] != "-":
        text = (x, y, "NO APLICA", str(formato_numero(no_aplica[0])), str(formato_numero(no_aplica[1])), str(no_aplica[2]), str(formato_numero(no_aplica[3])), str(formato_numero(no_aplica[4])), str(no_aplica[5]), str(no_aplica[6]), str(no_aplica[7]), str(no_aplica[8]) , a, fill )
        celda_afectaciones(pdf, 10, 162, text, rango, id)


    total_asesinados_2022 = datos_eln[0] + datos_gaor[0] + datos_cg[0] + gdo[0] + gao_cap[0] + gao_pel[0] + narcotrafico[0] + delco[0] + no_aplica[0]
    total_asesinados_2023 = datos_eln[1] + datos_gaor[1] + datos_cg[1] + gdo[1] + gao_cap[1] + gao_pel[1] + narcotrafico[1] + delco[1] + no_aplica[1]
    total_porcentaje_asinados = porcentajes(total_asesinados_2022, total_asesinados_2023,-1)

    total_heridos_2022 = datos_eln[3] + datos_gaor[3] + datos_cg[3] + gdo[3] + gao_cap[3] + gao_pel[3] + narcotrafico[3] + delco[3] + no_aplica[3]
    total_heridos_2023 = datos_eln[4] + datos_gaor[4] + datos_cg[4] + gdo[4] + gao_cap[4] + gao_pel[4] + narcotrafico[4] + delco[4] + no_aplica[4]
    total_porcentaje_heridos = porcentajes(total_heridos_2022, total_heridos_2023,-1)
