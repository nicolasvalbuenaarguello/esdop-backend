...
def encabezado_coe(pdf, fill, divisiones):
    ...
    pdf.cell(13,8,"TOTAL",1,0, 'C',fill)
    numero = numero +13
...
def tabla_boletin_coe(pdf, datos_res, text, divisiones):
    ...
    if numero != "-":
        ...
        for x in divisiones:
            ...
            pdf.cell(12,4,numero,1,0, 'C',True)
