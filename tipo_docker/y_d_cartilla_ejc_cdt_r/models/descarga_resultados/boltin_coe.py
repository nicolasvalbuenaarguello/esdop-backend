...
from tipo_docker.y_d_cartilla_ejc_cdt_r.models.funtions.pdf.boletin_coe import *
#Funcion de resultados nueva ayuda

def boletin_coe_cartilla_reducida(datos, link, ruta, puerto):


    nombre_carpeta = "cartillas_conesjo_presidencia_{}/".format(puerto)
    ...
    direcion = cartilla_ejc_cdt_r(fecha_primer_lapso_inicial, fecha_ultimo_lapso_inicial, fecha_primer_lapso_final, fecha_ultimo_lapso_final, filtros, dirercion_archvios, nombre_carpeta)
    dir = {
