...
from tipo_docker.p_c_afectaciones_mapa. models.estadistica.estadistica_boletin_coe import *
...
#Función para las afectaciones de las propias tropas con mapa
def afectaciones_con_mapa(fecha_inicial_u_l, fecha_final_u_l, fecha_inicial_p_l, fecha_final_p_l, filtro, dirercion_archvios, nombre_carpeta):
    ...
    img_qr =  "C:/Users/nicolas.valbuena/Documents/programacion 2023/server/tipo_docker/p_c_afectaciones_mapa/models/qr_img"
    
    pdf.parametros(titulo = titulo, tamanio = "oficio", logo = filtro[11], fecha_titulo = fecha_titulo, imagen = "static/img/oficio/Diapositiva18.JPG", seguridad="nueva_sin_mapa", img_qr = img_qr)
...
#--------
    ...
    resultados_spoa.afectaciones_propias_tropas_mapa(pdf, fecha_inicial_u_l, fecha_final_u_l, fecha_inicial_p_l, fecha_final_p_l, filtro, fechas_final[2], fechas_inicial[2], fecha_titulo, fecha_titulo_dos)
