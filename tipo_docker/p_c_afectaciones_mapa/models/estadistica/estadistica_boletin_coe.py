...
from tipo_docker.p_c_afectaciones_mapa.models.conexion_pos import Databa_bases
from tipo_docker.z_z_z_funtions.funciones import *
from tipo_docker.p_c_afectaciones_mapa.models.funtions.componest.tablas import *
from tipo_docker.p_c_afectaciones_mapa.maps.funciones.mapa_filtro import *
...
class Calculo_Spoa:
    ...
    def afectaciones_propias_tropas_mapa(self, pdf, fecha_inicial_u_l, fecha_final_u_l, fecha_inicial_p_l, fecha_final_p_l, filtro, anio_act, anio_ant, fecha_titulo, fecha_titulo_dos):
        ...
        afectaciones = [valor_1[0],valor_3[0]]

        cuadro_afectaciones(pdf, datos, filtro)
        #calculo de afectaciones propias tropas

        afecataciones_propias_tropas(afectaciones, filtro)

        afectaciones_img  = '{}static/img/img_mapas/afectaciones.png'.format(filtro[15])
        afectaciones_img_fondo  = '{}static/img/img_mapas/afectaciones_fondo.png'.format(filtro[15])

        rosa_nautica = '{}static/img/img_mapas/rosa_nautica_2024_new.png'.format(filtro[15])
        pdf.image(afectaciones_img_fondo,13,18.7,162.1,199)
        pdf.image(afectaciones_img,-8,5,180,220)
