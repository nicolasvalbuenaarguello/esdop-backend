...
from tipo_docker.p_c_afectaciones_mapa.models.funtions.pdf.boletin_coe import *
#Funcion de resultados nueva ayuda

def afectaciones_mapa(datos, link, ruta, puerto):

   
    nombre_carpeta = "afectaciones_mapa{}/".format(puerto)
    ...
    direcion = afectaciones_con_mapa(fecha_primer_lapso_inicial, fecha_ultimo_lapso_inicial, fecha_primer_lapso_final, fecha_ultimo_lapso_final, filtros, dirercion_archvios, nombre_carpeta)
