...
from tipo_docker.j_c_boletin_comparativo_enemigo.models.funtions.pdf.boletin_coe import *
def boletin_coe_comparativo_amenaza(datos, link, ruta, puerto):
         
    nombre_carpeta = "boletin_coe_comparativo_amenaza{}/".format(puerto)
    ...
    direcion = comparativo_enemigo(fecha_primer_lapso_inicial, fecha_ultimo_lapso_inicial, fecha_primer_lapso_final, fecha_ultimo_lapso_final, filtros, dirercion_archvios, nombre_carpeta)
