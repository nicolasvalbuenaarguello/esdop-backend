...
from tipo_docker.j_c_boletin_comparativo_enemigo.models.conexion_pos import Databa_bases
from tipo_docker.z_z_z_funtions.funciones import *
from tipo_docker.j_c_boletin_comparativo_enemigo.models.funtions.componest.tablas import *
...
class Calculo_Spoa:
    ...
    def comparativo_divisiones_enemigo(self, pdf, fecha_inicial_u_l, fecha_final_u_l, fecha_inicial_p_l, fecha_final_p_l, filtro, anio_act, anio_ant):
        ...
        pdf.cell(-5)
        fill = True
        encabezado_coe_div_compa(pdf, fill, anio_act, anio_ant)
        
        separador_cuadro_coe(pdf, fill, "AFECTACIÓN A LA AMENAZA")
        calculo_comparativo_enemigo(pdf, res_calculo_ante[0], res_calculo_act[0], "MENORES RECUPERADOS",1, 7, 18)    
        calculo_comparativo_enemigo(pdf, res_calculo_ante[1], res_calculo_act[1], "PRESENTACIÓN VOLUNTARIA",1, 7, 18)
        calculo_comparativo_enemigo(pdf, res_calculo_ante[2], res_calculo_act[2], "SOMETIMIENTOS",1, 7, 18)
        ...
        calculo_comparativo_enemigo(pdf, valor_ant[0], valor_act[0], "CAPTURAS",1, 7, 18)
        ...
        calculo_comparativo_enemigo(pdf, valor_ant[0], valor_act[0], "MDOM",1, 7, 18)
        ...
        calculo_comparativo_enemigo(pdf, valor_ant[0], valor_act[0], "ASESINADOS",-1, 7, 18)
        ...
        calculo_comparativo_enemigo(pdf, valor_ant[0], valor_act[0], "HERIDOS",-1, 7, 18)
        ...
        calculo_comparativo_enemigo(pdf, valor_ant[0], valor_act[0], "ARMAS DE LARGO ALCANCE",1, 7, 18)
        ...
        calculo_comparativo_enemigo(pdf, valor_ant[0], valor_act[0], "ARMAS DE CORTO ALCANCE",1, 7, 18)
        valor_ant = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo_ante, 9,  "SI") #funcion para filtar el spoa
        valor_act = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo_act, 9,  "SI") #funcion para filtar el spo
        calculo_comparativo_enemigo(pdf, valor_ant[0], valor_act[0], "ARMAS DE ACOMPAÑAMIENTO",1, 7, 18)
        valor_ant = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo_ante, 10,  "SI") #funcion para filtar el spoa
        valor_act = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo_act, 10,  "SI") #funcion para filtar el spo
        calculo_comparativo_enemigo(pdf, valor_ant[0], valor_act[0], "MUNICIONES",1, 7, 18)

        separador_cuadro_coe(pdf, fill, "COMBATES")
        calculo_comparativo_enemigo(pdf, res_calculo_ante[11], res_calculo_act[11], "COMBATES POSITIVOS",1, 8, 14)
        calculo_comparativo_enemigo(pdf, res_calculo_ante[12], res_calculo_act[12], "COMBATES NEGATIVOS",1, 8, 14)
        calculo_comparativo_enemigo(pdf, res_calculo_ante[13], res_calculo_act[13], "COMBATES SIN RESULTADOS",1, 8, 14)
        calculo_comparativo_enemigo(pdf, res_calculo_ante[14], res_calculo_act[14], "TOTAL DE COMBATES",1, 8, 14)


        separador_cuadro_coe(pdf, fill, "MATERIAL DE EXPLOSIVOS")
        calculo_comparativo_enemigo(pdf, res_calculo_ante[15], res_calculo_act[15], "NEUTRALIZACIÓN TERRORISTA",1, 8, 14)
        calculo_comparativo_enemigo(pdf, res_calculo_ante[16], res_calculo_act[16], "A.E",1, 7, 18)
        calculo_comparativo_enemigo(pdf, res_calculo_ante[17], res_calculo_act[17], "MAP(Mina Anti Persona)",1, 7, 18)
        calculo_comparativo_enemigo(pdf, res_calculo_ante[18], res_calculo_act[18], "EXPLOSIVOS kg",1, 7, 18)
        calculo_comparativo_enemigo(pdf, res_calculo_ante[19], res_calculo_act[19], "CORDÓN DETONANTE m",1, 7, 18)
        calculo_comparativo_enemigo(pdf, res_calculo_ante[20], res_calculo_act[20], "MECHA LENTA m",1, 7, 18)
        ...
        calculo_comparativo_enemigo(pdf, valor_ant[0], valor_act[0], "COCAÍNA Kg",1, 7, 18)
        ...
        calculo_comparativo_enemigo(pdf, valor_ant[0], valor_act[0], "MARIHUANA Kg",1, 7, 18)
        ...
        calculo_comparativo_enemigo(pdf, valor_ant[0], valor_act[0], "PBC Kg",1, 7, 18)
        ...
        calculo_comparativo_enemigo(pdf, valor_ant[0], valor_act[0], "LAB. CLORHIDRATO DE COCAINA",1, 7, 18)
        ...
        calculo_comparativo_enemigo(pdf, valor_ant[0], valor_act[0], "LAB. PASTA O BASE DE COCA",1, 7, 18)
        ...
        calculo_comparativo_enemigo(pdf, valor_ant[0], valor_act[0], "SEMILLEROS",1, 7, 18)
        ...
        calculo_comparativo_enemigo(pdf, valor_ant[0], valor_act[0], "MATA(S) DE COCA EN SEMILLERO",1, 7, 18)
        ...
        calculo_comparativo_enemigo(pdf, valor_ant[0], valor_act[0], "INSUMOS LIQUIDOS Gal",1, 7, 18)
        calculo_comparativo_enemigo(pdf, res_calculo_ante[29], res_calculo_act[29], "INSUMOS SOLIDOS Kg",1, 7, 18)
        ...
        calculo_comparativo_enemigo(pdf, valor_ant[0], valor_act[0], "CAPTURAS PLAN AMAZONIA",1, 7, 18)
        calculo_comparativo_enemigo(pdf, res_calculo_ante[31], res_calculo_act[31], "PLANTULAS SEMBRADA",1, 7, 18)
        calculo_comparativo_enemigo(pdf, res_calculo_ante[32], res_calculo_act[32], "MADERA INCAUTADA",1, 7, 18)
        calculo_comparativo_enemigo(pdf, res_calculo_ante[63], res_calculo_act[63], "ANIMALES INCAUTADOS",1, 7, 18)
        ...
        calculo_comparativo_enemigo(pdf, valor_ant[0], valor_act[0], "CAPTURAS MINERIA",1, 7, 18)
        calculo_comparativo_enemigo(pdf, res_calculo_ante[34], res_calculo_act[34], "MENORES R. MINERIA",1, 7, 18)
        calculo_comparativo_enemigo(pdf, res_calculo_ante[35], res_calculo_act[35], "EIYM",1, 8, 14)
        calculo_comparativo_enemigo(pdf, res_calculo_ante[36], res_calculo_act[36], "EXCAVADORA(S)",1, 7, 18)
        calculo_comparativo_enemigo(pdf, res_calculo_ante[37], res_calculo_act[37], "RETROEXCAVADORA(S)",1, 7, 18)
        calculo_comparativo_enemigo(pdf, res_calculo_ante[38], res_calculo_act[38], "MAQUINARIA PESADA",1, 7, 18)
        calculo_comparativo_enemigo(pdf, res_calculo_ante[39], res_calculo_act[39], "BULDOCER(ES)",1, 7, 18)
        calculo_comparativo_enemigo(pdf, res_calculo_ante[40], res_calculo_act[40], "UPM ILEGAL",1, 7, 18)
        calculo_comparativo_enemigo(pdf, res_calculo_ante[41], res_calculo_act[41], "DRAGA(S)",1, 7, 18)
        calculo_comparativo_enemigo(pdf, res_calculo_ante[65], res_calculo_act[65], "COLTAN KG",1, 7, 18)

        separador_cuadro_coe(pdf, fill, "ECONOMÍAS ILÍCITAS")
        calculo_comparativo_enemigo(pdf, res_calculo_ante[42], res_calculo_act[42], "LIBERADOS",1, 7, 18)
        calculo_comparativo_enemigo(pdf, res_calculo_ante[43], res_calculo_act[43], "RESCATADOS",1, 7, 18)
        calculo_comparativo_enemigo(pdf, res_calculo_ante[44], res_calculo_act[44], "VÁLVULAS",1, 7, 18)
        calculo_comparativo_enemigo(pdf, res_calculo_ante[45], res_calculo_act[45], "REFINERIAS",1, 7, 18)

        separador_cuadro_coe(pdf, fill, "DEPÓSITOS")
        calculo_comparativo_enemigo(pdf, res_calculo_ante[46], res_calculo_act[46], "DEPÓSITO ILEGAL",1, 7, 18)
