...
from tipo_docker.y_o_resultados_lineas_obj2_plan.models.estadistica.estadistica_boletin_coe import *
...
def comparativo_comparativo_mapa(fecha_inicial_u_l, fecha_final_u_l, fecha_inicial_p_l, fecha_final_p_l, filtro, dirercion_archvios, nombre_carpeta):
    ...
    pdf.set_text_color(56,87,35)
    pdf.text(20,150, "OBJ #2")
    pdf.set_text_color(0,0,0)
    pdf.text(20,162, "“DEBILITAR LAS")
    pdf.text(20,174, "CAPACIDADES DE LA ")
    pdf.text(20,186, "AMENAZA”")
    ...
    fecha_titulo_sub = 'Debilitar las capaciades de la amenaza'
    ...
    nombre_doc = "Seguimiento_obj_2 {}".format(unidad)
