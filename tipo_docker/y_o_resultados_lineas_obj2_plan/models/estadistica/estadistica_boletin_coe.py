...
from tipo_docker.y_o_resultados_lineas_obj2_plan.models.conexion_pos import Databa_bases
from tipo_docker.z_z_z_funtions.funciones import *
from tipo_docker.y_o_resultados_lineas_obj2_plan.models.funtions.componest.tablas import *
...
class Calculo_Spoa:
    ...
    def comparativo_mapa(self):
        ...
        datos = [valor_cap[0], valor_mdom[0]]
        datos_ant = [valor_cap_ant[0], valor_mdom_ant[0]]
