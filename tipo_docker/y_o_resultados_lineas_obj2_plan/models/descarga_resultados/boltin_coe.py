...
from tipo_docker.y_o_resultados_lineas_obj2_plan.models.funtions.pdf.boletin_coe import *
#Funcion de resultados nueva ayuda

def ayuda_comparativa_obj_2(datos, link, ruta, puerto):

    nombre_carpeta = "ayuda_comparativa_obj_2{}/".format(puerto)
