...
from tipo_docker.c_c_boletin_estadistica_narcotrafico_power_point.models.funtions.pdf.boletin_coe import *
#Funcion de resultados nueva ayuda

def c_c_boletin_estadistica_narcotrafico_power_point(datos, link, ruta, puerto):
    ...
    direcion = pdf_boletin_narcotrafico(fecha_primer_lapso_inicial, fecha_ultimo_lapso_inicial, filtros, link, puerto, fecha_primer_lapso_final, fecha_ultimo_lapso_final) 
