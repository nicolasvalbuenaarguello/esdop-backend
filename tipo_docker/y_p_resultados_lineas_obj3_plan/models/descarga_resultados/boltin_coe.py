...
from tipo_docker.y_p_resultados_lineas_obj3_plan.models.funtions.pdf.boletin_coe import *
#Funcion de resultados nueva ayuda

def ayuda_comparativa_obj_3(datos, link, ruta, puerto):

    nombre_carpeta = "ayuda_comparativa_obj_3{}/".format(puerto)
