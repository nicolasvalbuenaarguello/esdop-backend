...
from tipo_docker.r_c_regiones_colombia.models.estadistica.estadistica_boletin_coe import *
...
#funcion para crear la estadistica de las regiones de colombia
def regiones_colombia(fecha_inicial_u_l, fecha_final_u_l, filtro, dirercion_archvios,nombre_carpeta):
    ...
    img_qr =  "C:/Users/nicolas.valbuena/Documents/programacion 2023/server/tipo_docker/r_c_regiones_colombia/models/qr_img"
...
#--------
    ...
    resultados_spoa.calculo_boletin_regiones(fecha_inicial_u_l, fecha_final_u_l, filtro, pdf)

    titulo = "Resultados por Regiones"
