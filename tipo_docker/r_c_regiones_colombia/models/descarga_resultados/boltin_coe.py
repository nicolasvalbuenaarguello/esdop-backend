...
def regiones_colombia_v(datos, link, ruta,puerto):

    nombre_carpeta = "regiones_colombia{}/".format(puerto)
    ...
    direcion =  regiones_colombia(fecha_primer_lapso_inicial, fecha_ultimo_lapso_inicial, filtros,dirercion_archvios,nombre_carpeta)
    dir = {
