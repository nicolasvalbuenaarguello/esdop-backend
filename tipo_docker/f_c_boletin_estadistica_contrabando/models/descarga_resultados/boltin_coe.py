...
from tipo_docker.f_c_boletin_estadistica_contrabando.models.funtions.pdf.boletin_coe import *
#Funcion de resultados nueva ayuda

def boletin_coe_comtrabando(datos, link, ruta, puerto):
          
    nombre_carpeta = "contrabando{}/".format(puerto)
    ...
    direcion = pdf_boletin_contrabando(fecha_primer_lapso_inicial, fecha_ultimo_lapso_inicial, filtros, dirercion_archvios, nombre_carpeta)
