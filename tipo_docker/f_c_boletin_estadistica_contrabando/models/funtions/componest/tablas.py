...
def estadistica_resultados(datos_res, hechos, filtro):
    ...
    return[capturas_contrabando, gasolina_contrabando, acpm_contrabando, insumos_liquidos_contrabando, vehiculos_contrabando, animales_incautados_contrabando, elementos_escolares_contrabando, jugueteria_contrabando,prendas_vestir_contrabando, hechos_contrabando, combustibles_contrabando, licores, cigarrillos, telefonos, muebles_contrabando]
