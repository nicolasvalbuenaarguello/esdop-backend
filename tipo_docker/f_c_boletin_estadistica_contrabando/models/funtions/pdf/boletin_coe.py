...
from tipo_docker.f_c_boletin_estadistica_contrabando.models.estadistica.estadistica_boletin_coe import *
...
def pdf_boletin_contrabando(fecha_inicial_u_l, fecha_final_u_l, filtro, dirercion_archvios, nombre_carpeta):
    ...
    img_qr =  "C:/Users/nicolas.valbuena/Documents/programacion 2023/server/tipo_docker/f_c_boletin_estadistica_contrabando/models/img_qr"
...
#--------
    ...
    # fechas en el titulo
    res_spoa = Calculo_Spoa()
    res_spoa.resultados_contrabando_boletin(fecha_inicial_u_l, fecha_final_u_l, filtro, pdf)
