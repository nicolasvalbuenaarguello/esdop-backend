...
def encabezado_coe(pdf, fill):
    ...
    pdf.cell(46,5,"DIVISIONES",1,0, 'C',fill)
    pdf.cell(cel,10,"DIV01",1,0, 'C',fill)
    pdf.cell(cel,10,"DIV02",1,0, 'C',fill)
    pdf.cell(cel,10,"DIV03",1,0, 'C',fill)
    pdf.cell(cel,10,"DIV04",1,0, 'C',fill)
    pdf.cell(cel,10,"DIV05",1,0, 'C',fill)
    pdf.cell(cel,10,"DIV06",1,0, 'C',fill)
    pdf.cell(cel,10,"DIV07",1,0, 'C',fill)
    pdf.cell(cel,10,"DIV08",1,0, 'C',fill)
    pdf.cell(cel,10,"DAVAA",1,0, 'C',fill)
    pdf.cell(cel,10,"DIVFE",1,0, 'C',fill)
    pdf.cell(cel,10,"FUTOM",1,0, 'C',fill)
    pdf.cell(cel,10,"TREJC",1,0, 'C',fill)
    ...
    pdf.cell(16,10,"GAO-CS",1,0, 'C',fill)
    ...
    pdf.ln(5)
    pdf.cell(-5)
    pdf.cell(46,5,"EVENTO",1,0, 'C',fill)
...
def separador_cuadro_coe(pdf, fill, text):
    ...
    pdf.set_text_color(0,0,0)
    pdf.set_fill_color(227, 227, 211)
    pdf.cell(348.5,5,text,1,0, 'C',fill)
...
def tabla_boletin_coe(pdf, datos_res, text):
    ...
    pdf.ln(5)
    pdf.cell(-5)
    pdf.cell(46,5,text,1,0, 'L',True)
    pdf.set_font('Calibri', 'B', 9)

    total = 0
    cel = 14.2
    numero = calculo(datos_res, "DIV01", 1, 18)
    pdf.cell(cel,5,numero,1,0, 'C',False)
    ...
    numero = calculo(datos_res, "FUTOM", 1, 18)
    pdf.cell(cel,5,numero,1,0, 'C',False)
               
                  
    numero = calculo(datos_res, "TREJC", 1, 18)
    pdf.cell(cel,5,numero,1,0, 'C',False)
    ...
    pdf.set_fill_color(50, 54, 41)                 
    numero = calculo(datos_res, "GAO COMUNEROS DEL SUR", 7, 18)
    pdf.cell(16,5,numero,1,0, 'C',True)
...
def tabla_boletin_coe_hechos(pdf, datos_res, text):
    ...
    numero = calculo(datos_res, "FUTOM", 2, 14)
    pdf.cell(cel,5,numero,1,0, 'C',False)
               
                   
    numero = calculo(datos_res, "TREJC", 2, 14)
    pdf.cell(cel,5,numero,1,0, 'C',False)
