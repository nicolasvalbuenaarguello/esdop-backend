...
from tipo_docker.y_c_boletin_estadistica.models.funtions.pdf.boletin_coe import *

def a_a_boletin_estadistica_token_replicas(datos, link, ruta, puerto):

    nombre_carpeta = "cuadros_coe_{}/".format(puerto)
    ...
    direcion =  estadistica_resaltantes(fecha_primer_lapso_inicial, fecha_ultimo_lapso_inicial, filtros,dirercion_archvios, nombre_carpeta)
