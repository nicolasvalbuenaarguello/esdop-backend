...
def boletin_coe_comparativo_mineria(datos, link, ruta, puerto):

    nombre_carpeta = "mineria_v_comparativo{}/".format(puerto)
    ...
    direcion = boletin_estadistica_mineria_comparativo(fecha_primer_lapso_inicial, fecha_ultimo_lapso_inicial, fecha_primer_lapso_final, fecha_ultimo_lapso_final, filtros, dirercion_archvios, nombre_carpeta)
