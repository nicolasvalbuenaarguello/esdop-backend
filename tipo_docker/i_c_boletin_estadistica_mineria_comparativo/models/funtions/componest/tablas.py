...
def encabezado_tabla_resultados_mapa_compa(pdf, text, anio_act, anio_ant):
    ...
    pdf.ln(20)
    pdf.cell(147)
    pdf.cell(171,10,text,1,0, 'C',True)
    pdf.set_fill_color(208,208,182)
    pdf.set_text_color(0,0,0)
    pdf.ln(10)
    pdf.cell(147)
    pdf.cell(60,10,"INDICADOR",1,0, 'C',True)
    pdf.cell(28,10,str(anio_ant),1,0, 'C',True)
    pdf.cell(28,10,str(anio_act),1,0, 'C',True)
    pdf.cell(25,10,"%",1,0, 'C',True)
...
def tabla_resultados_con_mapa_comp(pdf,text,datos_res_ant, datos_res_act, unidad, suma, constante):
    ...
    pdf.set_font('Arial', '', 12)
    pdf.cell(28,10,str(res[0]),1,0, 'C',False)
    pdf.cell(28,10,str(res[1]),1,0, 'C',False)
    pdf.cell(25,10,str(res[2]),1,0, 'C',False)
...
#funcion para titulos de resutados 
    ...
    pdf.cell(60,10,text,1,0, 'L',False)
    pdf.set_font('Arial', '', 12)
    pdf.cell(28,10,str(maquinari_amarialla_anterior),1,0, 'C',False)
    pdf.cell(28,10,str(maquinari_amarialla_actual),1,0, 'C',False)
    pdf.cell(25,10,str(resultados),1,0, 'C',False)
    pdf.cell(30,10,unidad,1,0, 'C',False)
