...
from tipo_docker.c_c_boletin_estadistica_narcotrafico.models.funtions.pdf.boletin_coe import *
#Funcion de resultados nueva ayuda

def a_i_boletin_estadistica_narcotrafico_token(datos, link, ruta, puerto):

    nombre_carpeta = "resultados_narcotrafico{}/".format(puerto)
