...
from tipo_docker.c_c_boletin_estadistica_narcotrafico.models.estadistica.estadistica_boletin_coe import *
...
def pdf_boletin_narcotrafico(fecha_inicial_u_l, fecha_final_u_l, filtro, dirercion_archvios, nombre_carpeta):
    ...
    img_qr =  "C:/Users/nicolas.valbuena/Documents/programacion 2023/server/tipo_docker/c_c_boletin_estadistica_narcotrafico/models/qr_img"
    ...
    calcular_spoa.resultados_narcotrafico_boletin(fecha_inicial_u_l, fecha_final_u_l, filtro, pdf)
