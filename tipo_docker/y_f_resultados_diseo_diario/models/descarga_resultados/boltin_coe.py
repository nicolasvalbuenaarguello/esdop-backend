...
from tipo_docker.y_f_resultados_diseo_diario.models.funtions.pdf.boletin_coe import *
#Funcion de resultados nueva ayuda

def boletin_coe_diario_diseo(datos, link, ruta, puerto):


    nombre_carpeta = "diario_diseo_{}/".format(puerto)
    ...
    com_metas_narcotrafico = datos["com_metas_narcotrafico"]
    ...
    # print(documento)
    filtros = (agr_div, Div_FT, br, ut, filtro, dpto, mpio, enemigo, op_mayores, apoyo_unidad, afectaciones, tipo_titulo, permiso, unidad, fullname, ruta, spoa, delco_cap, estrategia, gaulas, coordinadas, conjuntas, tipo_afectaciones, tipo_operacion, cdte, hechos, acam_enemigo, acam_estructura, ene_estructura, com_metas_narcotrafico, subregion)

    direcion = resultados_resaltantes_comparativo(fecha_primer_lapso_inicial, fecha_ultimo_lapso_inicial, fecha_primer_lapso_final, fecha_ultimo_lapso_final, filtros, dirercion_archvios, nombre_carpeta)
