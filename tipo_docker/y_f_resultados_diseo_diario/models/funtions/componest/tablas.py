...
#funcion para el grupo de resultados comparativos para la lamina de los muñecos
def grupo_result_resal_comparativa_metas (pdf, pos_vert, pos, elemento, datos_res_ant, datos_res_act, suma, imagen, filtro, const):
    ...
    dato_por = porcentajes(datos_res_ant, resultado_act, const)
    
    resultado_act = formato_numero(resultado_act)
    resultado_ant = formato_numero(datos_res_ant)
