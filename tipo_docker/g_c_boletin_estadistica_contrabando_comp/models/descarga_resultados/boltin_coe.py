...
def contrabando_comparativo(datos, link, ruta, puerto):
         
    nombre_carpeta = "contrabando_comparativo{}/".format(puerto)
    ...
    direcion = boletin_estadistica_contrabando_comp(fecha_primer_lapso_inicial, fecha_ultimo_lapso_inicial, fecha_primer_lapso_final, fecha_ultimo_lapso_final, filtros, dirercion_archvios, nombre_carpeta)
