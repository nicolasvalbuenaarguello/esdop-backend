...
def rutas_mapas(filtro):
    ...
    #C:\Users\nicolas.valbuena\Documents\programacion 2023\server\shappes\departamentos
    ...
    if filtro[5]!="" and filtro[5]!="---":
        if "," in filtro[5]:
            ...
            departamentos = '{}shappes/departamentos/{}.shp'.format(ruta, filtro[5])
            print("---")
    else:
        departamentos = '{}shappes/DEPARTA/Export_Output_7.shp'.format(ruta)
...
def mapa_filtrado(dato, filtro):
        ...
        foto = '{}static/img/img_mapas/{}.png'.format(filtro[15],filtro[0])
