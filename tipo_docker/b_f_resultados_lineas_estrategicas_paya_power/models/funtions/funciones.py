...
def selecion_filtro(filtro):
    ...
    if len(acam_enemigo[0])>1:
        res_acam_enemigo = "and acam_enemigo {}".format(valor_acam_enemigo) 
        
    if len(acam_estructura[0])>1:
        res_acam_estructura = "acam_estructura unidad {}".format(valor_acam_estructura) 


    if len(ene_estructura[0])>1:
        res_ene_estructura = "and ene_estructura {}".format(valor_ene_estructura) 
    ...
    resultados = " {} {} {} {} {} {} {} {} {} {} {} {} {}" .format(res_depto, res_mpio, res_enemigo, res_ope, res_apoyo, res_unidad, res_br, res_div_hija, res_div_padre, cdte, res_acam_enemigo, res_acam_estructura, res_ene_estructura)
    hechos = " {} {} {} {} {} {} {} {} {} {} {} {} {}".format(hop_dpto, hop_mpio, hop_enemigo, res_ope, res_apoyo, hop_unidad, hop_br, hop_div_hija, hop_div_padre, cdte, res_acam_enemigo, res_acam_estructura, res_ene_estructura)
