...
def estadistica_resultados(datos_res, hechos, filtro):
    ...
    #upm
    upm = list(filter(lambda afectacion_mineria: 'UPM ILEGAL' in afectacion_mineria[12] or 'UPM LEGAL' in afectacion_mineria[12] or 'SOCAVON' in afectacion_mineria[12], afectacion_mineria))#organizado
    #maquinaria pesada
