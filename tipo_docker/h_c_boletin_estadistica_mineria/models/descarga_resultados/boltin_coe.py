...
from tipo_docker.h_c_boletin_estadistica_mineria.models.funtions.pdf.boletin_coe import *
#Funcion de resultados nueva ayuda

def boletin_coe_mineria(datos, link, ruta,puerto):
         
    nombre_carpeta = "mineria_v{}/".format(puerto)
