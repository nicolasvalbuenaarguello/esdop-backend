...
from tipo_docker.l_c_boletin_comparativo.models.estadistica.estadistica_boletin_coe import *
...
from tipo_docker.z_z_configuarcion.titulos import titulos_name 

#comparativo por divisiones
def comparativo_comparativo(fecha_inicial_u_l, fecha_final_u_l, fecha_inicial_p_l, fecha_final_p_l, filtro, dirercion_archvios,nombre_carpeta):
    ...
    img_qr =  "C:/Users/nicolas.valbuena/Documents/programacion 2023/server/tipo_docker/l_c_boletin_comparativo/models/img_qr"
...
#--------
    ...
    resultados_spoa.comparativo_resultados(pdf, fecha_inicial_u_l, fecha_final_u_l, fecha_inicial_p_l, fecha_final_p_l, filtro, fechas_final[2], fechas_inicial[2],fecha_titulo, fecha_titulo_dos)
