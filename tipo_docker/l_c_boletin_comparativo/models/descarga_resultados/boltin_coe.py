...
from tipo_docker.l_c_boletin_comparativo.models.funtions.pdf.boletin_coe import *
def boletin_comparativo(datos, link, ruta, puerto):

    nombre_carpeta = "boletin_comparativo{}/".format(puerto)
    ...
    direcion = comparativo_comparativo(fecha_primer_lapso_inicial, fecha_ultimo_lapso_inicial, fecha_primer_lapso_final, fecha_ultimo_lapso_final, filtros, dirercion_archvios,nombre_carpeta)
