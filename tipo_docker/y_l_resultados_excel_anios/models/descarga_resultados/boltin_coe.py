...
from tipo_docker.y_l_resultados_excel_anios.models.funtions.pdf.boletin_coe import *
#Funcion de resultados nueva ayuda

def excel_anios_permiso_excel(datos, link, ruta, puerto):

    nombre_carpeta = "excel_anios_permiso_excel{}/".format(puerto)
