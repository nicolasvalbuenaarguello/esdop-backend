...
def calculo(datos_res, parametro, identificador, identificador_suma):
    ...
    for dato in datos_res:
        ...
        if str(parametro) in str(dato[identificador]):
...
def calculo_2(datos_res, parametro, parametro_2, identificador, identificador_2, identificador_suma):
    numero = 0
    
    for dato in datos_res:

        if str(parametro) in str(dato[identificador]) and str(parametro_2) in str(dato[identificador_2]):
            numero =  numero + float(dato[identificador_suma])
