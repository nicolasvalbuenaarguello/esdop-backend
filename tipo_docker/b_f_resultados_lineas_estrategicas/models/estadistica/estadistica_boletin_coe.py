...
from tipo_docker.b_f_resultados_lineas_estrategicas.models.conexion_pos import Databa_bases
from tipo_docker.z_z_z_funtions.funciones import *
from tipo_docker.b_f_resultados_lineas_estrategicas.models.funtions.componest.tablas import *
...
class Calculo_Spoa:
    ...
    def comparativo_mapa_2(self):
        ...
        if numero > 2:
            self.pdf.ln(5)   
            sepador_mapa_dos(self.pdf, True, "COMBATES", 20, 230)
            self.pdf.ln()
            encabezado_comparativo_mapa(self.pdf, True,  self.anio_act, self.anio_ant, 20)
            self.pdf.ln()
        ...
        if numero > 2:
            self.pdf.ln(5) 
            sepador_mapa_dos(self.pdf, True, "GUERRA DE MINAS", 20, 230)
            self.pdf.ln()
            encabezado_comparativo_mapa(self.pdf, True,  self.anio_act, self.anio_ant, 20)
            self.pdf.ln()
        ...
        #def comparativo_mapa_3(self):
            ...
            sepador_mapa_dos(self.pdf, True, "AFECTACIÓN A LAS ECONOMÍAS ILÍCITAS - NARCOTRÁFICO", 20, 230)
            self.pdf.ln()
            encabezado_comparativo_mapa(self.pdf, True,  self.anio_act, self.anio_ant, 20)
            self.pdf.ln()
        ...
        if numero > 2:
            self.pdf.ln(5) 
            sepador_mapa_dos(self.pdf, True, "AFECTACIÓN A LAS ECONOMÍAS ILÍCITAS - MINERÍA ILEGAL", 20, 230)
            self.pdf.ln()
            encabezado_comparativo_mapa(self.pdf, True,  self.anio_act, self.anio_ant, 20)
            self.pdf.ln()
        ...
        if numero > 2:
            ...
            sepador_mapa_dos(self.pdf, True, "AFECTACIÓN A LAS ECONOMÍAS ILÍCITAS - CONTRA LA LIBERTAD PERSONAL", 20, 230)
            self.pdf.ln()
            encabezado_comparativo_mapa(self.pdf, True,  self.anio_act, self.anio_ant, 20)
            self.pdf.ln()
        ...
        #def comparativo_mapa_4(self):
            ...
            sepador_mapa_dos(self.pdf, True, "AFECTACIÓN A LAS ECONOMÍAS ILÍCITAS - HIDROCARBUROS", 20, 230)
            self.pdf.ln()
            encabezado_comparativo_mapa(self.pdf, True,  self.anio_act, self.anio_ant, 20)
            self.pdf.ln()
        ...
        if numero > 2:
            self.pdf.ln(5) 
            sepador_mapa_dos(self.pdf, True, "LOE AMAZONÍA", 20, 230)
            self.pdf.ln()
            encabezado_comparativo_mapa(self.pdf, True,  self.anio_act, self.anio_ant, 20)
            self.pdf.ln()
