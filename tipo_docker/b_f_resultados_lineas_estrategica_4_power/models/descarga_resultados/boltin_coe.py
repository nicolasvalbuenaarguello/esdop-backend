...
from tipo_docker.b_f_resultados_lineas_estrategica_4_power.models.funtions.pdf.boletin_coe import *
#Funcion de resultados nueva ayuda

def ayuda_comparativa_obj_4(datos, link, ruta, puerto):

    nombre_carpeta = "ayuda_comparativa_obj_4{}/".format(puerto)
