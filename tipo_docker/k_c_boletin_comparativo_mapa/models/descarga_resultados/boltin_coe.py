...
from tipo_docker.k_c_boletin_comparativo_mapa.models.funtions.pdf.boletin_coe import *
#Funcion de resultados nueva ayuda

def boletin_comparativo_mapa(datos, link, ruta,puerto):

    nombre_carpeta = "boletin_comparativo_mapa{}/".format(puerto)
