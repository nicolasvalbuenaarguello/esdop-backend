...
from tipo_docker.k_c_boletin_comparativo_mapa. models.estadistica.estadistica_boletin_coe import *
...
def comparativo_comparativo_mapa(fecha_inicial_u_l, fecha_final_u_l, fecha_inicial_p_l, fecha_final_p_l, filtro, dirercion_archvios,nombre_carpeta):
    ...
    img_qr =  "C:/Users/nicolas.valbuena/Documents/programacion 2023/server/tipo_docker/k_c_boletin_comparativo_mapa/models/img_qr"
...
#--------
    ...
    resultados_spoa.comparativo_mapa(pdf, fecha_inicial_u_l, fecha_final_u_l, fecha_inicial_p_l, fecha_final_p_l, filtro, fechas_final[2], fechas_inicial[2],fecha_titulo, fecha_titulo_dos)
