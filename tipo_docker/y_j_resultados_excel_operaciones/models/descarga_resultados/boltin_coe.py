...
from tipo_docker.y_j_resultados_excel_operaciones.models.funtions.pdf.boletin_coe import *
#Funcion de resultados nueva ayuda

def resultados_excel_tipo_operaciones_excel(datos, link, ruta, puerto):


    nombre_carpeta = "resultados_excel_tipo_operaciones_excel{}/".format(puerto)
    ...
    direcion = resultados_resaltantes_comparativo_div(fecha_primer_lapso_inicial, fecha_ultimo_lapso_inicial, filtros, dirercion_archvios, nombre_carpeta)
    dir = {
