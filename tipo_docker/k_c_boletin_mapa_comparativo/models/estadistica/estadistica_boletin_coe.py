...
from tipo_docker.k_c_boletin_mapa_comparativo.models.conexion_pos import Databa_bases
from tipo_docker.z_z_z_funtions.funciones import *
from tipo_docker.k_c_boletin_mapa_comparativo.models.funtions.componest.tablas import *
from tipo_docker.k_c_boletin_mapa_comparativo.maps.funciones.mapa_filtro import *
import json
...
#     sepador_mapa(pdf, True, "AFECTACIÓN A PROPIAS TROPAS ", -7, 1, 115)
#     pdf.ln(6)
#     altura =  pos+6.9
...
#     sepador_mapa(pdf, True, "MATERIAL DE EXPLOSIVOS", 228, 1, 115)
#     pdf.ln(6)
#     altura =  pos+7
...
#funcion para calcular resultados  
    ...
    def comparativo_mapa(self, pdf, fecha_inicial_u_l, fecha_final_u_l, fecha_inicial_p_l, fecha_final_p_l, filtro, anio_act, anio_ant, fecha_titulo, fecha_titulo_dos, fecha_titulo_tres, fecha_anio_tres_inicial, fecha_anio_tres_final, anio_ant_tres):
        ...
        pdf.set_font('Arial', 'B', 8)
        # pdf.text(10,42.5,fecha_titulo_tres)
        pdf.text(10,44,fecha_titulo_dos)
        pdf.text(10,48.5, fecha_titulo)
        ...
        hechos=[]
        # print(filtro)
        # hechos_actual_combates=[]
        # for x in hechos_actual:
        #     if x[0] == "COMBATE":
        #         print(x[0])
        #         hechos_actual_combates.append(x)
        ...
        sepador_mapa(pdf, True, "AFECTACIÓN A LA AMENAZA ", -7, 12, 115)
        encabezado_comparativo_mapa_2(pdf, True, anio_act, anio_ant, anio_ant_tres,  -7)

        # sepador_mapa(pdf, True, "AFECTACIÓN A LA AMENAZA ", 228, 12, 115)
        # encabezado_comparativo_mapa(pdf, True, anio_act, anio_ant, anio_ant_tres,  225)
        altura = 61
        pos = claculo_mapa_2(pdf, res_calculo_ante[0], res_calculo_act[0], res_calculo_ante_tres[0], "MENORES RECUPERADOS",1, 7, 18, -7, ruta, 72, altura)
        altura =  pos
        pos = claculo_mapa_2(pdf, res_calculo_ante[1], res_calculo_act[1], res_calculo_ante_tres[0], "PRESENTACIÓN VOLUNTARIA",1, 7, 18, -7, ruta, 72, altura)
        altura =  pos
        pos = claculo_mapa_2(pdf, res_calculo_ante[2], res_calculo_act[2],res_calculo_ante_tres[2], "SOMETIMIENTOS",1, 7, 18,  -7, ruta, 72, altura)
        altura =  pos
        ...
        pos = claculo_mapa_2(pdf, valor_ant[0], valor_act[0],valor_ant_tres[0], "CAPTURAS",1, 7, 18, -7, ruta, 72, altura)
        altura =  pos
        ...
        pos = claculo_mapa_2(pdf, valor_ant[0], valor_act[0],valor_ant_tres[0], "MDOM",1, 7, 18, -7, ruta, 72, altura)
        ...
        pos = claculo_mapa_2(pdf, valor_ant[0], valor_act[0],valor_ant_tres[0], "ASESINADOS",-1, 7, 18, -7, ruta, 72, altura)
        altura =  pos
        ...
        pos = claculo_mapa_2(pdf, valor_ant[0], valor_act[0],valor_ant_tres[0], "HERIDOS",-1, 7, 18, -7, ruta, 72, altura)
        ...
        pos = claculo_mapa_2(pdf, valor_ant[0], valor_act[0],valor_ant_tres[0], "ARMAS DE LARGO ALCANCE",1, 7, 18, -7, ruta, 72, altura)
        altura =  pos
        ...
        pos = claculo_mapa_2(pdf, valor_ant[0], valor_act[0],valor_ant_tres[0], "ARMAS DE CORTO ALCANCE",1, 7, 18, -7, ruta, 72, altura)
        altura =  pos
        ...
        pos = claculo_mapa_2(pdf, valor_ant[0], valor_act[0],valor_ant_tres[0], "ARMAS DE ACOMPAÑAMIENTO",1, 7, 18, -7, ruta, 72, altura)
        altura =  pos
        ...
        pos = claculo_mapa_2(pdf, valor_ant[0], valor_act[0],valor_ant_tres[0], "MUNICIONES",1, 7, 18, -7, ruta, 72, altura)

        sepador_mapa(pdf, True, "COMBATES", -7, 1, 115)
        pdf.ln(6)

        altura =  pos+7
        pos = claculo_mapa_2(pdf, res_calculo_ante[11], res_calculo_act[11],res_calculo_ante_tres[11], "COMBATES POSITIVOS",1, 8, 14, -7, ruta, 72, altura)
        altura =  pos
        pos = claculo_mapa_2(pdf, res_calculo_ante[12], res_calculo_act[12],res_calculo_ante_tres[12], "COMBATES NEGATIVOS",-1, 8, 14, -7, ruta, 72, altura)
        altura =  pos
        pos = claculo_mapa_2(pdf, res_calculo_ante[13], res_calculo_act[13],res_calculo_ante_tres[13], "COMBATES SIN RESULTADOS",-1, 8, 14, -7, ruta, 72, altura)
        altura =  pos
        pos = claculo_mapa_2(pdf, res_calculo_ante[14], res_calculo_act[14],res_calculo_ante_tres[14], "TOTAL DE COMBATES",1, 8, 14, -7, ruta, 72, altura)

        sepador_mapa(pdf, True, "ATAQUES A LA FUERZA PUBLICA", -7, 1, 115)
        pdf.ln(6)
        altura =  pos+7.5
        pos = claculo_mapa_2(pdf, res_calculo_ante[66], res_calculo_act[66],res_calculo_ante_tres[66], "HOSTIGAMIENTOS",-1, 7, 18, -7, ruta, 72, altura)
        altura =  pos
        pos = claculo_mapa_2(pdf, res_calculo_ante[67], res_calculo_act[67],res_calculo_ante_tres[67], "ASONADAS",-1, 7, 18, -7, ruta, 72, altura)


        pdf.ln(-184)
        sepador_mapa(pdf, True, "NARCOTRÁFICO", 228, 12, 115)
        encabezado_comparativo_mapa_2(pdf, True, anio_act, anio_ant, anio_ant_tres,  228)
        ...
        pos = claculo_mapa_2(pdf, valor_ant[0], valor_act[0], valor_ant_tres[0], "COCAÍNA Kg",1, 7, 18, 228, ruta, 307, altura)
        altura =  pos
        ...
        pos = claculo_mapa_2(pdf, valor_ant[0], valor_act[0], valor_ant_tres[0], "MARIHUANA Kg",1, 7, 18, 228, ruta, 307, altura)
        altura =  pos
        ...
        pos = claculo_mapa_2(pdf, valor_ant[0], valor_act[0], valor_ant_tres[0], "PBC Kg",1, 7, 18, 228, ruta, 307, altura)
        altura =  pos
        ...
        pos = claculo_mapa_2(pdf, valor_ant[0], valor_act[0], valor_ant_tres[0], "LAB. CLORHIDRATO DE COCAINA",1, 7, 18, 228, ruta, 307, altura)
        altura =  pos
        ...
        pos = claculo_mapa_2(pdf, valor_ant[0], valor_act[0], valor_ant_tres[0], "LAB. PASTA O BASE DE COCA",1, 7, 18, 228, ruta, 307, altura)
        altura =  pos
        ...
        pos = claculo_mapa_2(pdf, valor_ant[0], valor_act[0], valor_ant_tres[0], "SEMILLEROS",1, 7, 18, 228, ruta, 307, altura)

        sepador_mapa(pdf, True, "MATERIAL DE EXPLOSIVOS", 228, 1, 115)
        pdf.ln(6)
        altura =  pos+7
        pos = claculo_mapa_2(pdf, res_calculo_ante[15], res_calculo_act[15], res_calculo_ante_tres[15], "NEUTRALIZACIÓN TERRORISTA",1, 8, 14, 228, ruta, 307, altura)
        altura =  pos
        pos = claculo_mapa_2(pdf, res_calculo_ante[16], res_calculo_act[16], res_calculo_ante_tres[16], "A.E",1, 7, 18, 228, ruta, 307, altura)
        altura =  pos
        pos = claculo_mapa_2(pdf, res_calculo_ante[17], res_calculo_act[17], res_calculo_ante_tres[17], "MAP (Mina Anti Persona)",1, 7, 18, 228, ruta, 307, altura)
        altura =  pos
        pos = claculo_mapa_2(pdf, res_calculo_ante[18], res_calculo_act[18], res_calculo_ante_tres[18], "EXPLOSIVOS kg",1, 7, 18, 228, ruta, 307, altura)
        altura =  pos
        pos = claculo_mapa_2(pdf, res_calculo_ante[19], res_calculo_act[19], res_calculo_ante_tres[19], "CORDÓN DETONANTE m",1, 7, 18, 228, ruta, 307, altura)
        altura =  pos
        pos = claculo_mapa_2(pdf, res_calculo_ante[20], res_calculo_act[20], res_calculo_ante_tres[20], "MECHA LENTA m",1, 7, 18, 228, ruta, 307, altura)

        sepador_mapa(pdf, True, "ECONOMÍAS ILÍCITAS", 228, 1, 115)
        pdf.ln(6)
        altura =  pos+7
        pos = claculo_mapa_2(pdf, res_calculo_ante[42], res_calculo_act[42], res_calculo_ante_tres[42], "LIBERADOS",1, 7, 18, 228, ruta, 307, altura)
        altura =  pos
        pos = claculo_mapa_2(pdf, res_calculo_ante[43], res_calculo_act[43], res_calculo_ante_tres[43], "RESCATADOS",1, 7, 18, 228, ruta, 307, altura)
        altura =  pos
        pos = claculo_mapa_2(pdf, res_calculo_ante[44], res_calculo_act[44], res_calculo_ante_tres[44], "VÁLVULAS",1, 7, 18, 228, ruta, 307, altura)
        altura =  pos
        pos = claculo_mapa_2(pdf, res_calculo_ante[45], res_calculo_act[45], res_calculo_ante_tres[45], "REFINERIAS",1, 7, 18, 228, ruta, 307, altura)
        ...
        pos = claculo_mapa_2(pdf, valor_ant[0], valor_act[0], valor_ant_tres[0], "CAPTURAS MINERIA",1, 7, 18, 228, ruta, 307, altura)
        altura =  pos
        pos = claculo_mapa_2(pdf, res_calculo_ante[35], res_calculo_act[35], res_calculo_ante_tres[35], "EIYM",1, 8, 14, 228, ruta, 307, altura)
        altura =  pos
        ...
        pos = claculo_mapa_mapa_2(pdf, maquinaria_anterior, maquinaria_anctual, maquinaria_anterior_tres, "MAQUINARIA AMARILLA",1, 7, 18, 228, ruta, 307, altura)
        
        altura =  pos
        pos = claculo_mapa_2(pdf, res_calculo_ante[65], res_calculo_act[65], res_calculo_ante_tres[65], "COLTAN kg",1, 7, 18, 228, ruta, 307, altura)
        ...
        pos = claculo_mapa_2(pdf, valor_ant[0], valor_act[0], valor_ant_tres[0], "CAPTURAS PLAN AMAZONIA",1, 7, 18, 228, ruta, 307, altura)
        altura =  pos
        pos = claculo_mapa_2(pdf, res_calculo_ante[32], res_calculo_act[32], res_calculo_ante_tres[32], "MADERA INCAUTADA",1, 7, 18, 228, ruta, 307, altura)
        altura =  pos
        pos = claculo_mapa_2(pdf, res_calculo_ante[63], res_calculo_act[63], res_calculo_ante_tres[63], "ANIMALES INCAUTADOS",1, 7, 18, 228, ruta, 307, altura)
        altura =  pos
        pos = claculo_mapa_2(pdf, res_calculo_ante[31], res_calculo_act[31], res_calculo_ante_tres[31], "PLANTULAS SEMBRADA",1, 7, 18, 228, ruta, 307, altura)
