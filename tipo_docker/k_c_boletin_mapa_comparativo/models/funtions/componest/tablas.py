...
def encabezado_comparativo_mapa_2(pdf, fill, anio_act, anio_ant, anio_ant_tres, ancho):
    ...
    # pdf.ln(-8)
    # pdf.cell(ancho+34)
    pdf.multi_cell(27, 8, str(anio_ant), 1, "C", fill)
    pdf.ln(-8)
    ...
    pdf.multi_cell(27, 8, str(anio_act), 1, "C", fill)
    pdf.ln(-8)
    pdf.cell(ancho+34+27+27)
    porc = "% "+str(anio_ant)+"   / "+str(anio_act)
    pdf.multi_cell(26.8, 8, str(porc), 1, "C", fill)
...
def claculo_mapa_mapa_2(pdf, datos_res_ant,  datos_res_act, res_calculo_ante_tres, text, constante, id_enemigo, suma, ancho, ruta, altu_img, pos_img):
    ...
    # pdf.ln(x*-1)
    # pdf.cell(ancho+34+17)
    pdf.multi_cell(27, x, maquinari_amarialla_anterior_2, 1, "C", False)
    pdf.ln(x*-1)
    pdf.cell(ancho+34+27)
    ...
    # pdf.ln(x*-1)
    # pdf.cell(ancho+34+27)
    pdf.multi_cell(27, x, maquinari_amarialla_actual, 1, "C", False)
    pdf.ln(x*-1)
    pdf.cell(ancho+34+27+27)
    ...
    pdf.multi_cell(26.8, x, porcentaje, 1, "C", True)
    pdf.ln(x*-1)
    pdf.set_text_color(0,0,0)
...
def claculo_mapa_2(pdf, datos_res_ant,  datos_res_act, res_calculo_ante_tres, text, constante, id_enemigo, suma, ancho, ruta, altu_img, pos_img):
    ...
    pdf.multi_cell(27, x, resultados[1], 1, "C", False)
    # pdf.ln(x*-1)
    # pdf.cell(ancho+34+27)
