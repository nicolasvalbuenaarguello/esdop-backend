...
from tipo_docker.k_c_boletin_mapa_comparativo.models.funtions.pdf.boletin_coe import *
#Funcion de resultados nueva ayuda

def boletin_mapa_comparativa(datos, link, ruta, puerto):

    nombre_carpeta = "boletin_mapa_comparativa{}/".format(puerto)
