...
def boletin_coe_semanal_diseo(datos, link, ruta, puerto):

    nombre_carpeta = "semanal_diseo_{}/".format(puerto)
    ...
    direcion = resultados_resaltantes_comparativo_div(fecha_primer_lapso_inicial, fecha_ultimo_lapso_inicial, fecha_primer_lapso_final, fecha_ultimo_lapso_final, filtros, dirercion_archvios, nombre_carpeta)
    dir = {
