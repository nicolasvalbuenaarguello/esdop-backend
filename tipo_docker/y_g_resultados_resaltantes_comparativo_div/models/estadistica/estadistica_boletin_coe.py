...
from tipo_docker.y_f_resultados_resaltantes_comparativo.models.conexion_pos import Databa_bases
from tipo_docker.z_z_z_funtions.funciones import *
from tipo_docker.y_f_resultados_resaltantes_comparativo.models.funtions.componest.tablas import *
...
class Calculo_Spoa:
    ...
    def resultados_resaltantes_pdf_oficio(self, fecha_inicial_u_l, fecha_final_u_l, filtro, pdf, dato):
        ...
        datos_res_afectaciones = [res_calculo[5], res_calculo[6]]
        pocision= 0
    ...
    def resultados_diarios_divisiones(self, pdf, fecha_inicial_u_l, fecha_final_u_l, filtro, fecha_titulo_dos):
        ...
        pdf.rounded_rect(284, 13, 70, 15, 1,'D', '1234')
        pdf.set_text_color(0,0,0)
        pdf.set_font('Arial', 'B', 12)
        pdf.text(285,19,"FECHA INFORMACIÓN")
        pdf.set_font('Arial', 'B', 10)
        pdf.text(285,25,fecha_titulo_dos)
        pdf.text(285,27,)
        #--------------------------------------------
        ...
        numero = resultados_diarios_divisiones_coe(pdf, res_calculo_act, "FUTOM", posiciones)    
        posiciones = [174, 198, -numero,187]
        numero = resultados_diarios_divisiones_coe(pdf, res_calculo_act, "DIVFE", posiciones)               
    ...
    def resultados_resaltantes_pdf_comparativo(self, pdf, fecha_inicial_u_l, fecha_final_u_l, fecha_inicial_p_l, fecha_final_p_l, filtro, anio_act, anio_ant, fecha_titulo, fecha_titulo_dos, dato):
        ...
        pdf.rounded_rect(284, 13, 70, 15, 1,'DF', '1234')
        pdf.set_text_color(0,0,0)
        pdf.set_font('Arial', 'B', 12)
        pdf.text(285,17,"FECHA INFORMACIÓN")
        pdf.set_font('Arial', 'B', 10)
        pdf.text(285,22,fecha_titulo)
        pdf.text(285,27,fecha_titulo_dos)
        pdf.set_fill_color(255, 255, 255)
        pdf.rounded_rect(285, 200, 70, 15, 1,'F', '1234')
        #--------------------------------------------
        ...
        datos_res_afectaciones_act = [res_calculo_act[5], res_calculo_act[6]]
        datos_res_afectaciones_ant = [res_calculo_ante[5], res_calculo_ante[6]]
        ...
        pos_vert = [118,116,48,23, 16,128,235,2, 182, 204, 227,220,2, 3]
        pdf.ln(-pos-6)               
        ...
        pos_vert = [238,236,45,23, 16,248,351,1, 299, 321, 342,337,3]
        pdf.ln(-pos+16)   
