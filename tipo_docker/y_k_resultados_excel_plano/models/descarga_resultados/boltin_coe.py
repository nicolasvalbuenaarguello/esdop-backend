...
from tipo_docker.y_k_resultados_excel_plano.models.funtions.pdf.boletin_coe import *
#Funcion de resultados nueva ayuda

def archivo_spoas_error_excel(datos, link, ruta, puerto ):

    nombre_carpeta = "archivo_spoas_error_excel{}/".format(puerto)
