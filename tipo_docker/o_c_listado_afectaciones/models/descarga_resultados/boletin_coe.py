...
from tipo_docker.o_c_listado_afectaciones.models.funtions.pdf.boletin_coe import *
#Funcion de resultados nueva ayuda

def listado_afectaciones_boletin(datos, link, ruta, puerto):

    nombre_carpeta = "listado_afectaciones{}/".format(puerto)
    ...
    direcion = listado_afectaciones(fecha_primer_lapso_inicial, fecha_ultimo_lapso_inicial, filtros,dirercion_archvios,nombre_carpeta)
