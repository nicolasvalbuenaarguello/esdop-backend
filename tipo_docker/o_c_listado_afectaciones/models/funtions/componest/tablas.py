...
def cuadro_heridos_asesinados(pdf, asesinados, heridos):
    ...
    res_asesinados_aplica = calculo(asesinados, "NO APLICA", 7, 18)
    res_heridos_aplica = calculo(heridos, "NO APLICA", 7, 18)
    total = suma_h_a(res_asesinados_aplica, res_heridos_aplica)

    if total != "-":
        numero = numero +1
        text = (x, y, str(numero),"NO APLICA", str(res_asesinados_aplica), str(res_heridos_aplica), str(total), a, fill )
        celda_afectaciones(pdf, 10, 172, text, rango, id)
...
def listados_pdf(pdf, resultados, parametro, parametro_dos, parametro_tres, text, id_parametro):
    ...
    if validacion != "":
        ...
        # pdf.ln(5)
                    # fechas en el titulo
        pdf.set_fill_color(250, 255, 255)
        pdf.rounded_rect(310, 195, 40, 20, 1,'F', '1234')
...
def listado_afectacion(pdf, resultados, text):
    ...
    listados_pdf(pdf, resultados, "FARC","FARC","FARC","FARC.", 7)

    listados_pdf(pdf, resultados, "BACRIM","BACRIM","BACRIM","BACRIM.", 7)

    listados_pdf(pdf, resultados, "EPL","EPL","EPL","EPL.", 7)



    listados_pdf(pdf, resultados, "DELINCUENCIA","DELINCUENCIA","DELINCUENCIA","DELCO", 7)

    listados_pdf(pdf, resultados, "NO APLICA","NO APLICA","NO APLICA","NO APLICA", 7)
