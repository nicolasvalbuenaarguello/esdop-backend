...
from tipo_docker.y_r_resultados_dash.models.conexion_pos import Databa_bases
from tipo_docker.z_z_z_funtions.funciones import *
from tipo_docker.y_r_resultados_dash.models.funtions.componest.tablas import *
...
class Calculo_Spoa:
    ...
    def __init__(self, fecha_inicial_u_l, fecha_final_u_l, filtro, obj):
            ...
            ruta = self.filtro[15] 
            json_ruta = '{}static/obj_plan_dasbohard.json'.format(ruta)
            ...
            informacion  = validar_indicador_unidad(json, json_ruta, self.obj)
  
            self.variables =informacion[0]
            self.constante =informacion[1]
            self.suma =informacion[2]
            self.posicion =informacion[3]
            self.spoa =informacion[4]

            self.img =informacion[5]
            self.estenxion =informacion[6]
    ...
    def comparativo_mapa_2(self):
            ...
            indicadores = encabezado_comparativo_enemigo_dinamico_2(dato_actu, self.suma, self.constante,  self.variables, self.img, self.estenxion )
