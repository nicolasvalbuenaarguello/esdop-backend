...
from tipo_docker.y_e_cartilla_ejc_cdt.models.funtions.pdf.boletin_coe import *
#Funcion de resultados nueva ayuda

def a_b_cartilla_ejc_cdt_token_replicas(datos, link, ruta, puerto):
    ...
    direcion = cartilla_ejc(fecha_primer_lapso_inicial, fecha_ultimo_lapso_inicial, fecha_primer_lapso_final, fecha_ultimo_lapso_final, filtros, dirercion_archvios, nombre_carpeta)
    dir = {
