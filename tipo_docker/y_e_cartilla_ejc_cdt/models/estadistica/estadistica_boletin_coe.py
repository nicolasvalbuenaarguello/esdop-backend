...
class Calculo_Spoa:
    ...
    def resultados_mineria_boletin_comp(self):
        ...
        datos = [valor[0], self.res_calculo_act[35], self.res_calculo_act[40], self.res_calculo_act[38], self.res_calculo_act[39], self.res_calculo_act[36], self.res_calculo_act[37], self.res_calculo_act[41], self.res_calculo_act[59], self.res_calculo_act[60], self.res_calculo_act[65]]

        datos_ant = [valor_1[0], self.res_calculo_ante[35], self.res_calculo_ante[40], self.res_calculo_ante[38], self.res_calculo_ante[39], self.res_calculo_ante[36], self.res_calculo_ante[37], self.res_calculo_ante[41], self.res_calculo_ante[59], self.res_calculo_ante[60], self.res_calculo_ante[65]]
    ...
    def resultados_contrabando_boletin_comp(self):
        ...
        datos = [valor[0], self.res_calculo_act[50], self.res_calculo_act[51], self.res_calculo_act[52], self.res_calculo_act[53], self.res_calculo_act[54], self.res_calculo_act[55], self.res_calculo_act[56], self.res_calculo_act[57], self.res_calculo_act[58]]

        res_calculo_ante = [valor_1[0], self.res_calculo_ante[50], self.res_calculo_ante[51], self.res_calculo_ante[52], self.res_calculo_ante[53], self.res_calculo_ante[54], self.res_calculo_ante[55], self.res_calculo_ante[56], self.res_calculo_ante[57], self.res_calculo_ante[58]]
        ...
        self.pdf.ln()
        tabla_resultados_con_mapa_comp(self.pdf,"Semovientes incautados",res_calculo_ante[5], datos[5], "Unidades", 18, 1)
    ...
    def resultados_narcotrafico_boletin(self):
        ...
        #encabezado de interdicion
        encabezado_tabla_resultados_mapa_compa(self.pdf, "RESULTADOS INTERDICCIÓN", self.anio_act, self.anio_ant)
        self.pdf.ln(10)
        ...
        valor = Calculo_Spoa.validar_spoa_unidad(self, self.filtro, self.res_calculo_ante, 21,  "SI") #funcion para filtar el spoa
        valor_1 = Calculo_Spoa.validar_spoa_unidad(self, self.filtro, self.res_calculo_ante, 23,  "SI") #funcion para filtar el spoa
        valor_2 = Calculo_Spoa.validar_spoa_unidad(self, self.filtro, self.res_calculo_ante, 29,  "SI") #funcion para filtar el spoa
        valor_3 = Calculo_Spoa.validar_spoa_unidad(self, self.filtro, self.res_calculo_ante, 22,  "SI") #funcion para filtar el spoa
        valor_4 = Calculo_Spoa.validar_spoa_unidad(self, self.filtro, self.res_calculo_ante, 47,  "SI") #funcion para filtar el spoa
        valor_5 = Calculo_Spoa.validar_spoa_unidad(self, self.filtro, self.res_calculo_ante, 48,  "SI") #funcion para filtar el spoa
        valor_6 = Calculo_Spoa.validar_spoa_unidad(self, self.filtro, self.res_calculo_ante, 28,  "SI") #funcion para filtar el spoa
        valor_7 = Calculo_Spoa.validar_spoa_unidad(self, self.filtro, self.res_calculo_ante, 24,  "SI") #funcion para filtar el spoa
        valor_8 = Calculo_Spoa.validar_spoa_unidad(self, self.filtro, self.res_calculo_ante, 25,  "SI") #funcion para filtar el spoa
        valor_9 = Calculo_Spoa.validar_spoa_unidad(self, self.filtro, self.res_calculo_ante, 26,  "SI") #funcion para filtar el spoa
        valor_10 = Calculo_Spoa.validar_spoa_unidad(self, self.filtro, self.res_calculo_ante, 69,  "SI") #funcion para filtar el spoa
        valor_11 = Calculo_Spoa.validar_spoa_unidad(self, self.filtro, self.res_calculo_ante, 68,  "SI") #funcion para filtar el spoa
        valor_12 = Calculo_Spoa.validar_spoa_unidad(self, self.filtro, self.res_calculo_ante, 70,  "SI") #funcion para filtar el spoa
        valor_13 = Calculo_Spoa.validar_spoa_unidad(self, self.filtro, self.res_calculo_ante, 71,  "SI") #funcion para filtar el spoa

        datos_ant = [valor[0], valor_1[0], valor_2[0], valor_3[0], valor_4[0], valor_5[0], valor_6[0], valor_7[0], valor_8[0], valor_9[0], valor_10[0], valor_11[0], valor_12[0], valor_13[0]]


        tabla_resultados_con_mapa_comp(self.pdf,"Clorhidrato de Cocaína", datos_ant[0], datos[0], "Kilos", 18, 1)
        self.pdf.ln()

        tabla_resultados_con_mapa_comp(self.pdf,"Pasta Base de Coca", datos_ant[1], datos[1], "Kilos", 18, 1)
        self.pdf.ln()

        tabla_resultados_con_mapa_comp(self.pdf,"Marihuana", datos_ant[3], datos[3], "Kilos", 18, 1)
        self.pdf.ln()

        tabla_resultados_con_mapa_comp(self.pdf,"Laboratorios CLHC", datos_ant[7], datos[7], "Unidades", 18, 1)
        self.pdf.ln()

        tabla_resultados_con_mapa_comp(self.pdf,"Laboratorios PBC", datos_ant[8], datos[8], "Unidades", 18, 1)
        self.pdf.ln()

        tabla_resultados_con_mapa_comp(self.pdf,"Insumos Líquidos", datos_ant[6], datos[6], "Galones", 18, 1)
        self.pdf.ln()
       
        tabla_resultados_con_mapa_comp(self.pdf,"Insumos Sólidos", datos_ant[2], datos[2], "Kilos", 18, 1)
        self.pdf.ln()
       
        tabla_resultados_con_mapa_comp(self.pdf,"Semilleros", datos_ant[9], datos[9], "Unidades", 18, 1)
        self.pdf.ln()
    ...
    def resultados_artemisas_boletin_comp(self):
        ...
        #encabezado de interdicion
        encabezado_tabla_resultados_mapa_compa(self.pdf, "LOE AMAZONÍA", self.anio_act, self.anio_ant)
        self.pdf.ln(10)
    ...
    def resultados_resaltantes_r_n(self):
        ...
        claculo_mapa_dos(self.pdf, self.res_calculo_ante[52], self.res_calculo_act[52], "INSUMOS LIQUIDOS GAL",1, 8, 18, 170)
    ...
    def resultados_afectaciones_a_la_amenaza(self):
        ...
        self.pdf.rounded_rect(4, 40, 347, 163, 1,'DF', '1234')

        # pdf.ln()
        claculo_afectacion_amenaza_cabecera(self.pdf,self.anio_act, self.anio_ant)

        self.pdf.set_fill_color(234, 236, 234)
        self.pdf.rounded_rect(5, 65, 345, 20, 1,'F', '1234')
        self.pdf.rounded_rect(5, 111, 345, 20, 1,'F', '1234')
        self.pdf.rounded_rect(5, 157, 345, 20, 1,'F', '1234')

        self.pdf.set_fill_color(210, 214, 209)
        self.pdf.rounded_rect(5, 88, 345, 20, 1,'F', '1234')
        self.pdf.rounded_rect(5, 134, 345, 20, 1,'F', '1234')
        self.pdf.rounded_rect(5, 180, 345, 20, 1,'F', '1234')
        ...
        self.pdf.rounded_rect(5, 180, 35, 20, 1,'F', '1234')
        ruta = self.filtro[15] 
        total = []
        total_ant = []
        valor_total = afectacion_ameneza_enemigo(self.pdf, "MENORES RECUPERADOS", 10,10, -5, self.res_calculo_ante[0], self.res_calculo_act[0], 18, 1, 7,ruta, 80)
        total =  total + valor_total[1]
        total_ant =  total_ant + valor_total[0]
        valor_total = afectacion_ameneza_enemigo(self.pdf, "PRESENTACIÓN VOLUNTARIA",13,10, -5, self.res_calculo_ante[1], self.res_calculo_act[1], 18, 1, 7,ruta,102)
        total =  total + valor_total[1]
        total_ant =  total_ant + valor_total[0]
        valor_total = afectacion_ameneza_enemigo(self.pdf, "SOMETIMIENTOS A LA JUSTICIA",10,10, -5, self.res_calculo_ante[2], self.res_calculo_act[2], 18, 1, 7,ruta,124)
        total =  total + valor_total[1]
        total_ant =  total_ant + valor_total[0]
        ...
        valor_total = afectacion_ameneza_enemigo(self.pdf, "CAPTURAS", 15,6, -5, valor_1[0], valor[0], 18, 1, 7,ruta, 148 )
        total =  total + valor_total[1]
        total_ant =  total_ant + valor_total[0]
        ...
        valor_total = afectacion_ameneza_enemigo(self.pdf, "MDOM", 9,7, -5, valor_1[0], valor[0], 18, 1, 7,ruta, 170 )
        total =  total + valor_total[1]
        total_ant =  total_ant + valor_total[0]

        afectacion_ameneza_enemigo_total(self.pdf, "TOTAL", 15,6, -5, total_ant, total, 18, 1, 7,ruta, 192)
