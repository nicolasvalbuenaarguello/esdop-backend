...
from tipo_docker.y_f_resultados_resaltantes_comparativo.models.funtions.pdf.boletin_coe import *
#Funcion de resultados nueva ayuda

def resultados_resaltantes_comparativo_v(datos, link, ruta,puerto):

    nombre_carpeta = "resultados_resaltantes_comparativo_v{}/".format(puerto)
