...
from tipo_docker.y_j_resultados_excel_amenaza.models.funtions.pdf.boletin_coe import *
#Funcion de resultados nueva ayuda

def excel_amenaza_excel(datos, link, ruta, puerto):


    nombre_carpeta = "excel_amenaza_excel{}/".format(puerto)
