...
from tipo_docker.y_j_resultados_excel_amenaza.models.estadistica.estadistica_boletin_coe import *
...
def resultados_resaltantes_comparativo_div(fecha_inicial_u_l, fecha_final_u_l,  filtro, dirercion_archvios, nombre_carpeta):
    ...
    wb.save(dirercion_archvios+ "resultados Amenaza.xlsx")

    
    titulo = "resultados Amenaza"
