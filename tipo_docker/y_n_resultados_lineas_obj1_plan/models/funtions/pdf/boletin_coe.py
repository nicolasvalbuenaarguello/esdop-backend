...
from tipo_docker.y_n_resultados_lineas_obj1_plan.models.estadistica.estadistica_boletin_coe import *
...
def comparativo_comparativo_mapa(fecha_inicial_u_l, fecha_final_u_l, fecha_inicial_p_l, fecha_final_p_l, filtro, dirercion_archvios, nombre_carpeta):
    ...
    pdf.set_text_color(56,87,35)
    pdf.text(20,150, "OBJ #1")
    pdf.set_text_color(0,0,0)
    pdf.text(20,162, "“PROTEGER")
    pdf.text(20,174, "LA POBLACIÓN")
    pdf.text(20,186, "CIVIL")
    ...
    fecha_titulo_sub = '"PROTEGER LA POBLACIÓN CIVIL"'

    titulo_unidad  =  titulos_name_lineas_estrategicas_obj1(filtro, fechas_final[2])
    ...
    nombre_doc = "Seguimiento_obj_1 {}".format(unidad)
    ...
    titulo_unidad  =  titulos_name_lineas_estrategicas_evaluacion_obj1(filtro, fechas_final[2])
