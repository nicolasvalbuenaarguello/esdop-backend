...
from tipo_docker.y_n_resultados_lineas_obj1_plan.models.funtions.pdf.boletin_coe import *
#Funcion de resultados nueva ayuda

def ayuda_comparativa_obj_1(datos, link, ruta, puerto):

    nombre_carpeta = "ayuda_comparativa_obj_1{}/".format(puerto)
