...
def estadistica_resultados(datos_res, hechos, filtro):
    ...
    asesinado_direfente_al_enemigo_v1 ="MUERTE POR CAUSAS DEL SERVICIO EN ENTRENAMIENTO" 
    asesinado_direfente_al_enemigo_v2 ="MUERTO POR CAUSAS DEL SERVICIO, DIFERENTES A LAS ACCIONES DIRECTAS DEL ENEMIGO" 
    ...
    asesinados_fuera_combate = list(filter(lambda datos_res: asesinado_direfente_al_enemigo in datos_res[28] or asesinado_direfente_al_enemigo_v1 in datos_res[28] or asesinado_direfente_al_enemigo_v2 in datos_res[28], datos_res))
    ...
    herido_fuera_combate = list(filter(lambda datos_res: herido_direfente_al_enemigo in datos_res[28] or herido_direfente_al_enemigo_v1 in datos_res[28], datos_res))
    ...
    derribado_con_drons = list(filter(lambda datos_res: "DERRIBADO(A)" in datos_res[9], datos_res))
...
def encabezado_comparativo_mapa_2(pdf, fill, anio_act, anio_ant, anio_ant_tres, ancho):
    ...
    # pdf.ln(-8)
    # pdf.cell(ancho+34)
    pdf.multi_cell(23, 8, str(anio_ant), 1, "C", fill)
    pdf.ln(-8)
    pdf.cell(ancho+34+23)
    # pdf.multi_cell(15, 4, str(porc), 1, "C", fill)
    # pdf.ln(-8)
    # pdf.cell(ancho+34+17+17)

    pdf.multi_cell(23, 8, str(anio_act), 1, "C", fill)
    pdf.ln(-8)
    pdf.cell(ancho+34+23+23)
    porc = "% "
    pdf.multi_cell(17, 8, str(porc), 1, "C", fill)
...
def claculo_mapa_mapa_2(pdf, datos_res_ant,  datos_res_act, res_calculo_ante_tres, text, constante, id_enemigo, suma, ancho, ruta, altu_img, pos_img):
    ...
    # pdf.ln(x*-1)
    # pdf.cell(ancho+34+17)
    pdf.multi_cell(23, x, maquinari_amarialla_anterior_2, 1, "C", False)
    pdf.ln(x*-1)
    pdf.cell(ancho+34+23)
    ...
    pdf.multi_cell(23, x, maquinari_amarialla_actual, 1, "C", False)
    pdf.ln(x*-1)
    pdf.cell(ancho+34+23+23)
    ...
    pdf.multi_cell(17, x, porcentaje, 1, "R", False)
    pdf.ln(x*-1)
    pdf.set_text_color(0,0,0)
...
def claculo_mapa_2(datos_res_ant,  datos_res_act, constante, id_enemigo, suma):
