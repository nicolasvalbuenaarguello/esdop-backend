...
from tipo_docker.b_f_resultados_lineas_estrategicas_sin_comparar.models.funtions.pdf.boletin_coe import *
#Funcion de resultados nueva ayuda

def configuracion_especial_res_sin_Comparar(datos, link, ruta, puerto):


    nombre_carpeta = "res_linea_obj_4{}/".format(puerto)
