...
from tipo_docker.s_c_resultados_resaltantes.models.funtions.pdf.boletin_coe import *
...
def b_c_resultados_resaltantes_token(datos, link, ruta, puerto):
    ...
    filtros = (agr_div, Div_FT, br, ut, filtro, dpto, mpio, enemigo, op_mayores, apoyo_unidad, afectaciones, tipo_titulo, permiso, unidad, fullname, ruta, spoa, delco_cap, estrategia, gaulas, coordinadas, conjuntas, tipo_afectaciones, tipo_operacion, cdte, hechos, acam_enemigo, acam_estructura, ene_estructura, subregion, afectacion)
