...
def cuadro_men_res(pdf, datos_res, enemigo, gao, gao_1, gao_2):
    ...
    if rme_resul != "-":
        ...
        pdf.cell(17,5,str(rme_resul),1,0, 'C',True)
        return 5
    else:
        return 0
...
def cuadro_menores_edad(pdf, datos_res):
    ...
    if rme_resul != "-":
        ...
        posicion = posi + posicion
        posi = cuadro_men_res(pdf, datos_res, "GAO-CS", "GAO COMUNEROS DEL SUR","GAO COMUNEROS DEL SUR","GAO COMUNEROS DEL SUR")
        posicion = posi + posicion
        ...
        posicion = posi + posicion
        posi = cuadro_men_res(pdf, datos_res, "OTROS","BACRIM","EPL","NO APLICA")
        posicion = posi + posicion
        pdf.set_font('Arial', 'B', 10)
        pdf.ln(5)
        pdf.cell(-5)
...
def cuadro_enemigo_afectaciones(pdf, posicion_inicial, datos_res):
    ...
    if total != "-":
        ...
        posicion = posi + posicion
        posi = cuadro_afect_enemigo(pdf, datos_res, "FARC", "FARC", "FARC", "FARC")
        posicion = posi + posicion
        ...
        posicion = posi + posicion
        posi = cuadro_afect_enemigo(pdf, datos_res, "GAO-CS", "GAO COMUNEROS DEL SUR","GAO COMUNEROS DEL SUR","GAO COMUNEROS DEL SUR")
        posicion = posi + posicion
        posi = cuadro_afect_enemigo(pdf, datos_res, "GAO-CAP", "GAO CAPARROS","GAO CAPARROS","GAO CAPARROS")
        posicion = posi + posicion
        posi = cuadro_afect_enemigo(pdf, datos_res, "GAO-DOT", "Delincuencia Organizada Transnacional","Delincuencia Organizada Transnacional","Delincuencia Organizada Transnacional")
        posicion = posi + posicion           
        ...
        posicion = posi + posicion
        posi = cuadro_afect_enemigo(pdf, datos_res, "OTROS","BACRIM","EPL","NO APLICA")
        posicion = posi + posicion
        pdf.set_font('Arial', 'B', 10)
        pdf.ln (5)
        pdf.cell(49)
