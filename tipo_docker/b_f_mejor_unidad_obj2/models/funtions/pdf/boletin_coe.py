...
from tipo_docker.b_f_mejor_unidad_obj2.models.estadistica.estadistica_boletin_coe import *
...
def comparativo_comparativo_mapa(fecha_inicial_u_l, fecha_final_u_l, fecha_inicial_p_l, fecha_final_p_l, filtro, link, puerto):
    ...
    nombre_doc = "{} - Mejores unidades".format(unidad)

    link_2 = link #carpeta base
    nombre_carpeta = f"mejor_unidad_{puerto}/"
    ...
    # Guardar archivo
    direcion = link+str(nombre_doc)+'.pdf'
