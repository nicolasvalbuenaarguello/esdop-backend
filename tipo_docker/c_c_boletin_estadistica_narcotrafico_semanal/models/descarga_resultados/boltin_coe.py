...
from tipo_docker.c_c_boletin_estadistica_narcotrafico_semanal.models.funtions.pdf.boletin_coe import *
#Funcion de resultados nueva ayuda

def c_c_boletin_estadistica_narcotrafico_semanal(datos, link, ruta, puerto):


    nombre_carpeta = "narcotrafico_semanal{}/".format(puerto)
