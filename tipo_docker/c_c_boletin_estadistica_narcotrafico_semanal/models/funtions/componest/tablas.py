...
def calculo_de_interdion(pdf,text, meta, datos_res_act, datos_anterior,  ln, texto, ruta,alt,pos):
    ...
    pdf.cell(15,5,porcentaje,1,0, 'R',False)
...
def calculo_de_interdion_solo(pdf,text, meta, datos_res_act,  ln, texto, ruta,alt,pos):
...
def valores_interdicion(pdf, ruta):
    ...
    pdf.image(ejc,120,50,130,130) 


    # ejc = '{}static/img/escudos/splash_cafe_n.png'.format(ruta)
    # pdf.image(ejc,15,40,25,25) 
    
    ejc = '{}static/img/escudos/COCAINA_new.png'.format(ruta)
    pdf.image(ejc,23,45,15,15) 

    # ejc = '{}static/img/escudos/splash_cafe_n.png'.format(ruta)
    # pdf.image(ejc,15,90,25,25) 
        
    ejc = '{}static/img/escudos/PBC_new.png'.format(ruta)
    pdf.image(ejc,23,95,15,15) 

    # ejc = '{}static/img/escudos/splash_verde_n.png'.format(ruta)
    # pdf.image(ejc,15,140,25,25) 
        
    ejc = '{}static/img/escudos/MARIHUNA_new.png'.format(ruta)
    pdf.image(ejc,23,145,15,15) 

    #-----------------------------------------------------------    
    #
    #-----------------------------------------------------------  

    # ejc = '{}static/img/escudos/splash_azul_n.png'.format(ruta)
    # pdf.image(ejc,239,40,25,25) 
            
    ejc = '{}static/img/escudos/LAB_COCAINA_new.png'.format(ruta)
    pdf.image(ejc,247,45,15,15) 


    # ejc = '{}static/img/escudos/splash_azul_n.png'.format(ruta)
    # pdf.image(ejc,239,90,25,25) 
            
    ejc = '{}static/img/escudos/LAB_PBC_new.png'.format(ruta)
    pdf.image(ejc,247,95,15,15) 



    # ejc = '{}static/img/escudos/splash_verde_n.png'.format(ruta)
    # pdf.image(ejc,239,140,25,25) 
            
    ejc = '{}static/img/escudos/SEMILLEROS_new.png'.format(ruta)
    pdf.image(ejc,247,143,15,15) 
...
def valores_tabla_interdicion_semilleros(pdf, ln, datos_res_act, texto):
    ...
    # pdf.set_text_color(0,0,0)
    numero_act = str(formato_numero(res))+str(" Und")
    pdf.cell(25,5,numero_act,0,0, 'L',False)
    ...
    # pdf.set_text_color(0,0,0)
    # pdf.set_font('Arial', '', 10)
    pdf.cell(60,5,"Matas de coca en semillero",0,0, 'L',False)
    pdf.cell(25,5,numero_act,0,0, 'L',False)
...
def valores_tabla_interdicion_marihuna(pdf, ln, datos_res_act, texto, valor ):
    ...
    numero_act = str(formato_numero(res))+str(" Kg")
    pdf.set_font('BebasNeue', '', 14)
    # pdf.cell(60,5,texto_rojo,0,0, 'L',False)
...
def valores_tabla_interdicion(pdf, ln, datos_res_act, texto, valor ):
    texto_rojo = "Valor "+texto
    numero_act = formato_numero(valor)
    valor_text = "USD "+str(numero_act)
    ...
    # pdf.set_text_color(0,0,0)
    # pdf.set_font('Arial', '', 10)
    pdf.cell(65,5,texto_NEGRO,0,0, 'L',False)
    pdf.cell(25,5,numero_act,0,0, 'L',False)
