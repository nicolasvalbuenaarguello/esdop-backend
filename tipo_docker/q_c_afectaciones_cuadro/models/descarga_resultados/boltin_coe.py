...
def b_a_afectaciones_cuadro_token(datos, link, ruta, puerto):


    nombre_carpeta = "afectaciones_cuadro{}/".format(puerto)
    ...
    direcion = afectaciones_cuadro(fecha_primer_lapso_inicial, fecha_ultimo_lapso_inicial, filtros,dirercion_archvios, nombre_carpeta)
    dir = {
