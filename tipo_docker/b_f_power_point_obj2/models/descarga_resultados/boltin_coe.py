import json
from tipo_docker.b_f_power_point_obj2.models.funtions.pdf.boletin_coe import *


def configuracion_especial_res_power_poin(datos: dict, link: str, ruta: str, puerto: int) -> dict:
    """
    ...
    resultado = pdf_boletin_narcotrafico(
        fechas[0],
        fechas[1],
        fechas[2],
        fechas[3],
