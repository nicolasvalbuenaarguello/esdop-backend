...
from tipo_docker.y_i_resultados_excel.models.conexion_pos import Databa_bases
from tipo_docker.z_z_z_funtions.funciones import *
from tipo_docker.y_i_resultados_excel.models.funtions.componest.tablas import *
...
class Calculo_Spoa:
    ...
    def resultados_resaltantes_pdf_oficio(self, fecha_inicial_u_l, fecha_final_u_l, filtro,  dato, wb):
        ...
        if filtro[12] == "EJC":
            ...
            unidad_resultados = ""
            unidad_erradicacion = ""
        elif filtro[12] == "agr_div":
            unidad_hechos = " and agr_div = '{}'".format(filtro[13])
            unidad_resultados = " and agr_div = '{}'".format(filtro[13])
            unidad_erradicacion = ""
        elif filtro[12] == "division ":
            unidad_hechos = " and division = '{}'".format(filtro[13])
            unidad_resultados = " and hop_div = '{}'".format(filtro[13])
            unidad_erradicacion = ""
        elif filtro[12] == "brigada":
            unidad_hechos = " and brigada = '{}'".format(filtro[13])
            unidad_resultados = " and hop_br  = '{}'".format(filtro[13])
            unidad_erradicacion = ""
        elif filtro[12] == "unidad":
            unidad_hechos = " and unidad = '{}'".format(filtro[13])
            unidad_resultados = " and hop_unidad  = '{}'".format(filtro[13])
            unidad_erradicacion = ""

        querys_unidades = "SELECT DISTINCT brigada, unidad  FROM view_hechos_materializados WHERE fecha_hecho >= '{}'  AND fecha_hecho <= '{}' {}  {} ORDER BY brigada ASC".format(fecha_inicial_u_l, fecha_final_u_l, hechos_filtro, unidad_hechos)
        listado_unidades = conexion_pos.comando_query(querys_unidades)
            
        querys_bris = "SELECT DISTINCT agr_div, brigada  FROM view_hechos_materializados WHERE fecha_hecho >= '{}'  AND fecha_hecho <= '{}' {}  {} ORDER BY agr_div ASC".format(fecha_inicial_u_l, fecha_final_u_l, hechos_filtro, unidad_hechos)
        listado_brig = conexion_pos.comando_query(querys_bris)
    
        querys_div = "SELECT DISTINCT agr_div  FROM view_hechos_materializados WHERE fecha_hecho >= '{}'  AND fecha_hecho <= '{}' {}  {} ORDER BY agr_div ASC".format(fecha_inicial_u_l, fecha_final_u_l, hechos_filtro, unidad_hechos)
        ...
        hoja.cell(row=8, column=1, value="ASESINADOS")
        hoja.cell(row=9, column=1, value="HERIDOS")

        #RESULTADOS ARMAMENTO

        hoja.cell(row=10, column=1, value="ARMAS DE LARGO ALCANCE")
        hoja.cell(row=11, column=1, value="ARMAS DE CORTO ALCANCE")
        hoja.cell(row=12, column=1, value="ARMAS DE ACOMPAÑAMIENTO")
        hoja.cell(row=13, column=1, value="MUNICIONES")

        #RESULTADOS COMBATES

        hoja.cell(row=14, column=1, value="COMBATES POSITIVOS")
        hoja.cell(row=15, column=1, value="COMBATES NEGATIVOS")
        hoja.cell(row=16, column=1, value="COMBATES SIN RESULTADOS")
        hoja.cell(row=17, column=1, value="TOTAL DE COMBATES")

        hoja.cell(row=18, column=1, value="HOSTIGAMIENTOS")
        hoja.cell(row=19, column=1, value="ASONADAS")

        #RESULTADOS NARCOTRAFICO
        hoja.cell(row=20, column=1, value="COCAÍNA Kg")
        hoja.cell(row=21, column=1, value="MARIHUANA Kg")
        hoja.cell(row=22, column=1, value="PBC Kg")
        hoja.cell(row=23, column=1, value="HEROHINA Kg")
        hoja.cell(row=24, column=1, value="BASUCO Kg")
        hoja.cell(row=25, column=1, value="DROGAS SINTETICAS und")
        hoja.cell(row=26, column=1, value="LAB. CLORHIDRATO DE COCAINA")
        hoja.cell(row=27, column=1, value="LAB. PASTA O BASE DE COCA")
        hoja.cell(row=28, column=1, value="LAB. HEROHINA")
        hoja.cell(row=29, column=1, value="SEMILLEROS")
        hoja.cell(row=30, column=1, value="MATAS DE COCA EN SEMILLEROS")
        hoja.cell(row=31, column=1, value="INSUMOS SOLIDOS Kg")
        hoja.cell(row=32, column=1, value="INSUMOS LIQUIDOS Gal")
        hoja.cell(row=33, column=1, value="COMBUSTIBLES NARCOTRAFICO Gal")

        #RESULTADOS EXPLOSIVOS
        hoja.cell(row=34, column=1, value="NEUTRALIZACIÓN TERRORISTA")
        hoja.cell(row=35, column=1, value="ARTEFACTOS EXPLOSIVOS Und")
        hoja.cell(row=36, column=1, value="A.E.I")
        hoja.cell(row=37, column=1, value="MAP (Mina Anti Persona)")
        hoja.cell(row=38, column=1, value="EXPLOSIVOS kg")
        hoja.cell(row=39, column=1, value="EXPLOSIVOS m")
        hoja.cell(row=40, column=1, value="EXPLOSIVOS Und")

        hoja.cell(row=41, column=1, value="CORDÓN DETONANTE m")
        hoja.cell(row=42, column=1, value="MECHA LENTA m")
        hoja.cell(row=43, column=1, value="MEDIOS DE LANZAMIENTOS")
        hoja.cell(row=44, column=1, value="DETONADORES ELÉCTRICOS")
        hoja.cell(row=45, column=1, value="DETONADORES ANELÉCTRICOS")

        hoja.cell(row=46, column=1, value="LIBERADOS")
        hoja.cell(row=47, column=1, value="RESCATADOS")
        
        #RESULTADOS HIDROCARBUROS
        hoja.cell(row=48, column=1, value="VÁLVULAS")
        hoja.cell(row=49, column=1, value="REFINERIAS")
        hoja.cell(row=50, column=1, value="AFECTACIONES AL OLEODUCTO")
        hoja.cell(row=51, column=1, value="PETROLEO")
        hoja.cell(row=52, column=1, value="PISCINAS")

        hoja.cell(row=53, column=1, value="INCAUTACION DE PESOS COLOMBIANOS")
        hoja.cell(row=54, column=1, value="INCAUTACION DE DOLARES")
        hoja.cell(row=55, column=1, value="INCAUTACION DE EUROS")

        #RESULTADOS AMAZONIA

        hoja.cell(row=56, column=1, value="CAPTURAS LOE AMAZONÍA")
        hoja.cell(row=57, column=1, value="PLÁNTULAS SEMBRADAS")
        hoja.cell(row=58, column=1, value="INCAUTACIÓN MADERA M3")
        hoja.cell(row=59, column=1, value="ESPECIES ANIMALES INCAUTADOS")

        #RESULTADOS MINERIA

        hoja.cell(row=60, column=1, value="CAPTURAS MINERIA")
        hoja.cell(row=61, column=1, value="YACIMIENTOS MINEROS")
        hoja.cell(row=62, column=1, value="UNIDAD MINERA PRODUCCIÓN")
        hoja.cell(row=63, column=1, value="MAQUINARIA PESADA")
        hoja.cell(row=64, column=1, value="TRACTOR CON URUGA")
        hoja.cell(row=65, column=1, value="EXCAVADORAS")
        hoja.cell(row=66, column=1, value="RETROEXCAVADORAS")
        hoja.cell(row=67, column=1, value="DRAGAS")
        hoja.cell(row=68, column=1, value="MAQUINARIA AMARILLA")
        hoja.cell(row=69, column=1, value="MOTORES")
        hoja.cell(row=70, column=1, value="MEDIOS DE TRANSPORTE")
        hoja.cell(row=71, column=1, value="COMBUSTIBLES EN MINERIA")
        hoja.cell(row=72, column=1, value="EXPLOSIVOS MINERIA kg")
        hoja.cell(row=73, column=1, value="EXPLOSIVOS MINERIA m")
        hoja.cell(row=74, column=1, value="EXPLOSIVOS MINERIA Und")
        hoja.cell(row=75, column=1, value="COLTAN")

        #RESULTADOS EXTINCION DE DOMINIO 

        hoja.cell(row=76, column=1, value="INCAUTACIÓN DE MUEBLES")
        hoja.cell(row=77, column=1, value="INCAUTACIÓN DE INMUEBLES")
        hoja.cell(row=78, column=1, value="INCAUTACIÓN DE VEHICULOS")

        #RESULTADOS CONTRABANDO 

        hoja.cell(row=79, column=1, value="CAPTURAS CONTRABANDO")
        hoja.cell(row=80, column=1, value="COMBUSTIBLES CONTRABANDO")
        hoja.cell(row=81, column=1, value="GASOLINA CONTRABANDO")
        hoja.cell(row=82, column=1, value="ACPM CONTRABANDO")
        hoja.cell(row=83, column=1, value="VEHICULOS DE CONTRABANDO")

        hoja.cell(row=84, column=1, value="AFECTACION OLEODUCTO")
        hoja.cell(row=85, column=1, value="APIQUE")
        hoja.cell(row=86, column=1, value="ABOYADURA")
        hoja.cell(row=87, column=1, value="ROTURA")
        hoja.cell(row=88, column=1, value="SABOTAJE AL OLEODUCTO")
        hoja.cell(row=89, column=1, value="TOTAL DE RESULTADOS")
        ...
        col= 2
        hoja.cell(row=2, column=col, value="TOTAL")
        hoja.cell(row=3, column=col, value=total_rme).number_format = frmt
        hoja.cell(row=4, column=col, value=total_presentacion).number_format = frmt
        hoja.cell(row=5, column=col, value=total_sometimientos).number_format = frmt
        hoja.cell(row=6, column=col, value=total_capturas).number_format = frmt
        hoja.cell(row=7, column=col, value=total_mdom).number_format = frmt

        hoja.cell(row=8, column=col, value=total_asesinados).number_format = frmt
        hoja.cell(row=9, column=col, value=total_heridos).number_format = frmt

        hoja.cell(row=10, column=col, value=total_largas).number_format = frmt
        hoja.cell(row=11, column=col, value=total_cortas).number_format = frmt
        hoja.cell(row=12, column=col, value=total_acompaniamientos).number_format = frmt
        hoja.cell(row=13, column=col, value=total_municinoes).number_format = frmt

        hoja.cell(row=14, column=col, value=total_combates_pos).number_format = frmt
        hoja.cell(row=15, column=col, value=total_combates_neg).number_format = frmt
        hoja.cell(row=16, column=col, value=total_combates_sin_res).number_format = frmt
        hoja.cell(row=17, column=col, value=total_combates).number_format = frmt

        hoja.cell(row=18, column=col, value=total_hostigamientos).number_format = frmt
        hoja.cell(row=19, column=col, value=total_asonadas).number_format = frmt

        hoja.cell(row=20, column=col, value=total_cocaina).number_format = frmt_d
        hoja.cell(row=21, column=col, value=total_marihuna).number_format = frmt_d
        hoja.cell(row=22, column=col, value=total_pbc).number_format = frmt_d
        hoja.cell(row=23, column=col, value=total_heronia).number_format = frmt_d
        hoja.cell(row=24, column=col, value=total_basuco).number_format = frmt_d
        hoja.cell(row=25, column=col, value=total_drogas_sinteticas).number_format = frmt
        hoja.cell(row=26, column=col, value=total_lab_cocaina).number_format = frmt
        hoja.cell(row=27, column=col, value=total_lab_pbc).number_format = frmt
        hoja.cell(row=28, column=col, value=total_lab_heronina).number_format = frmt
        hoja.cell(row=29, column=col, value=total_semilleros).number_format = frmt
        hoja.cell(row=30, column=col, value=total_matas_semilleros).number_format = frmt
        hoja.cell(row=31, column=col, value=total_insumos_solidos).number_format = frmt_d
        hoja.cell(row=32, column=col, value=total_insumos_liquidos).number_format = frmt_d
        hoja.cell(row=33, column=col, value=total_combustible_narcotrafico).number_format = frmt_d

                
        hoja.cell(row=34, column=col, value=total_neutralizacion_t).number_format = frmt
        hoja.cell(row=35, column=col, value=total_artefactos_explosivos).number_format = frmt
        hoja.cell(row=36, column=col, value=total_ae).number_format = frmt
        hoja.cell(row=37, column=col, value=total_map).number_format = frmt
        hoja.cell(row=38, column=col, value=total_explosivos).number_format = frmt_d
        hoja.cell(row=39, column=col, value=total_explosivos_m).number_format = frmt_d
        hoja.cell(row=40, column=col, value=total_explosivos_und).number_format = frmt_d

        hoja.cell(row=41, column=col, value=total_cordon).number_format = frmt_d
        hoja.cell(row=42, column=col, value=total_mecha).number_format = frmt_d
        hoja.cell(row=43, column=col, value=total_medios_lanzamientos).number_format = frmt
        hoja.cell(row=44, column=col, value=total_detonadores_electricos).number_format = frmt
        hoja.cell(row=45, column=col, value=total_detonadores_anaelectricos).number_format = frmt

        hoja.cell(row=46, column=col, value=total_liberados).number_format = frmt
        hoja.cell(row=47, column=col, value=total_rescatados).number_format = frmt
        hoja.cell(row=48, column=col, value=total_valvulas).number_format = frmt
        hoja.cell(row=49, column=col, value=total_refinerias).number_format = frmt

        hoja.cell(row=50, column=col, value=total_afectaciones_oleoducto).number_format = frmt
        hoja.cell(row=51, column=col, value=total_petroleo).number_format = frmt
        hoja.cell(row=52, column=col, value=total_piscinas).number_format = frmt

        hoja.cell(row=53, column=col, value=total_pesos).number_format = frmt
        hoja.cell(row=54, column=col, value=total_dolares).number_format = frmt
        hoja.cell(row=55, column=col, value=total_euros).number_format = frmt
    
        hoja.cell(row=56, column=col, value=total_cap_amazonia).number_format = frmt
        hoja.cell(row=57, column=col, value=total_plantulas).number_format = frmt
        hoja.cell(row=58, column=col, value=total_madera).number_format = frmt_d
        hoja.cell(row=59, column=col, value=total_especies).number_format = frmt

        hoja.cell(row=60, column=col, value=total_cap_menria).number_format = frmt
        hoja.cell(row=61, column=col, value=total_yacimiento_mineros).number_format = frmt
        hoja.cell(row=62, column=col, value=total_upm).number_format = frmt
        hoja.cell(row=63, column=col, value=total_maquinaria_pesada).number_format = frmt
        hoja.cell(row=64, column=col, value=total_tractor_con_oruga).number_format = frmt
        hoja.cell(row=65, column=col, value=total_excavadoras).number_format = frmt
        hoja.cell(row=66, column=col, value=total_retroexcavadoras).number_format = frmt
        hoja.cell(row=67, column=col, value=total_dragas).number_format = frmt
        hoja.cell(row=68, column=col, value=total_maquinaria_amarilla).number_format = frmt
        hoja.cell(row=69, column=col, value=total_motores).number_format = frmt
        hoja.cell(row=70, column=col, value=total_material_transporte).number_format = frmt
        hoja.cell(row=71, column=col, value=total_combustible_mineria).number_format = frmt
        hoja.cell(row=72, column=col, value=total_explosivos_mineria_kg).number_format = frmt
        hoja.cell(row=73, column=col, value=total_explosivos_mineria_m).number_format = frmt
        hoja.cell(row=74, column=col, value=total_explosivos_mineria_und).number_format = frmt
        hoja.cell(row=75, column=col, value=total_coltan).number_format = frmt

        hoja.cell(row=76, column=col, value=muebles).number_format = frmt
        hoja.cell(row=77, column=col, value=inmuebles).number_format = frmt
        hoja.cell(row=78, column=col, value=vehiculos).number_format = frmt

        hoja.cell(row=79, column=col, value=cap_contrabando).number_format = frmt
        hoja.cell(row=80, column=col, value=combustible_contrando).number_format = frmt
        hoja.cell(row=81, column=col, value=gasolina_contrabando).number_format = frmt
        hoja.cell(row=82, column=col, value=acpm_contrabando).number_format = frmt
        hoja.cell(row=83, column=col, value=vehiculos_contrando).number_format = frmt

        hoja.cell(row=84, column=col, value=afectacion_oleoducto).number_format = frmt
        hoja.cell(row=85, column=col, value=apique).number_format = frmt
        hoja.cell(row=86, column=col, value=aboyadura).number_format = frmt
        hoja.cell(row=87, column=col, value=destruido).number_format = frmt
        hoja.cell(row=88, column=col, value=saboteado).number_format = frmt
        hoja.cell(row=89, column=col, value=total_resultados).number_format = frmt
        ...
        for div in listado_div: 

            hoja = wb.create_sheet(div[0])

            my_border = Side(border_style="thin", color="000000")

            hoja.cell(row=1, column=1, value="Brigada")
            hoja.cell(row=2, column=1, value="Batallones")
            col = 2 
            col_merge_inicio = 2
            # print(res_calculo[1])
            listados=[]
            ...
            for y in listado_brig:
                ...
                if div[0] == y[0]:
                    ...
                    for x in listado_unidades:
                        if y[1] == x[0]:
                            ...
                            if  x[1] not in listados:
                                ...
                                hoja.cell(row=2, column=col, value=x[1])
                                hoja.cell(row=3, column=col, value=numero_res).number_format = frmt
                                hoja.cell(row=4, column=col, value=numero_presentacion).number_format = frmt
                                hoja.cell(row=5, column=col, value=sometimientos).number_format = frmt
                                hoja.cell(row=6, column=col, value=capturas).number_format = frmt
                                hoja.cell(row=7, column=col, value=mdom).number_format = frmt

                                hoja.cell(row=8, column=col, value=asesinados).number_format = frmt
                                hoja.cell(row=9, column=col, value=heridos).number_format = frmt

                                hoja.cell(row=10, column=col, value=largas).number_format = frmt
                                hoja.cell(row=11, column=col, value=cortas).number_format = frmt
                                hoja.cell(row=12, column=col, value=acompaniamiento).number_format = frmt
                                hoja.cell(row=13, column=col, value=municiones).number_format = frmt

                                hoja.cell(row=14, column=col, value=combates_pos).number_format = frmt
                                hoja.cell(row=15, column=col, value=combates_neg).number_format = frmt
                                hoja.cell(row=16, column=col, value=combates_sin_res).number_format = frmt
                                hoja.cell(row=17, column=col, value=combates).number_format = frmt

                                hoja.cell(row=18, column=col, value=hostigamientos).number_format = frmt
                                hoja.cell(row=19, column=col, value=asonadas).number_format = frmt

                                hoja.cell(row=20, column=col, value=cocaina).number_format = frmt_d
                                hoja.cell(row=21, column=col, value=marihuna).number_format = frmt_d
                                hoja.cell(row=22, column=col, value=pbc).number_format = frmt_d
                                hoja.cell(row=23, column=col, value=heronia).number_format = frmt_d
                                hoja.cell(row=24, column=col, value=basuco).number_format = frmt_d
                                hoja.cell(row=25, column=col, value=drogas_sinteticas).number_format = frmt
                                hoja.cell(row=26, column=col, value=lab_cocaina).number_format = frmt
                                hoja.cell(row=27, column=col, value=lab_pbc).number_format = frmt
                                hoja.cell(row=28, column=col, value=lab_heronina).number_format = frmt
                                hoja.cell(row=29, column=col, value=semilleros).number_format = frmt
                                hoja.cell(row=30, column=col, value=matas_semilleros).number_format = frmt
                                hoja.cell(row=31, column=col, value=insumos_solidos).number_format = frmt_d
                                hoja.cell(row=32, column=col, value=nsumos_liquidos).number_format = frmt_d
                                hoja.cell(row=33, column=col, value=combustible_contrabando).number_format = frmt_d

                                hoja.cell(row=34, column=col, value=neutralizacion_t).number_format = frmt
                                hoja.cell(row=35, column=col, value=artefacto_explosivo).number_format = frmt
                                hoja.cell(row=36, column=col, value=ae).number_format = frmt
                                hoja.cell(row=37, column=col, value=map).number_format = frmt
                                hoja.cell(row=38, column=col, value=explosivos).number_format = frmt_d
                                hoja.cell(row=39, column=col, value=explosivos_m).number_format = frmt_d
                                hoja.cell(row=40, column=col, value=explosivos_und).number_format = frmt_d
                                hoja.cell(row=41, column=col, value=cordon).number_format = frmt_d
                                hoja.cell(row=42, column=col, value=mecha).number_format = frmt_d
                                hoja.cell(row=43, column=col, value=medios_lanzamientos).number_format = frmt
                                hoja.cell(row=44, column=col, value=detonadores_electricos).number_format = frmt
                                hoja.cell(row=45, column=col, value=detonadores_anaelectricos).number_format = frmt
                
                                hoja.cell(row=46, column=col, value=liberados).number_format = frmt
                                hoja.cell(row=47, column=col, value=rescatados).number_format = frmt
                                hoja.cell(row=48, column=col, value=valvulas).number_format = frmt
                                hoja.cell(row=49, column=col, value=refinerias).number_format = frmt

                                hoja.cell(row=50, column=col, value=oleoducto).number_format = frmt
                                hoja.cell(row=51, column=col, value=petroleo).number_format = frmt
                                hoja.cell(row=52, column=col, value=piscina).number_format = frmt

                                hoja.cell(row=53, column=col, value=pesos).number_format = frmt
                                hoja.cell(row=54, column=col, value=dolares).number_format = frmt
                                hoja.cell(row=55, column=col, value=euros).number_format = frmt

                                hoja.cell(row=56, column=col, value=cap_amazonia).number_format = frmt
                                hoja.cell(row=57, column=col, value=plantulas).number_format = frmt
                                hoja.cell(row=58, column=col, value=madera).number_format = frmt_d
                                hoja.cell(row=59, column=col, value=especies).number_format = frmt

                                hoja.cell(row=60, column=col, value=cap_menria).number_format = frmt
                                hoja.cell(row=61, column=col, value=yacimiento_mineros).number_format = frmt
                                hoja.cell(row=62, column=col, value=upm).number_format = frmt
                                hoja.cell(row=63, column=col, value=maquinaria_pesada).number_format = frmt
                                hoja.cell(row=64, column=col, value=tractor_con_oruga).number_format = frmt
                                hoja.cell(row=65, column=col, value=excavadoras).number_format = frmt
                                hoja.cell(row=66, column=col, value=retroexcavadoras).number_format = frmt
                                hoja.cell(row=67, column=col, value=dragas).number_format = frmt
                                hoja.cell(row=68, column=col, value=maquinaria_amarilla).number_format = frmt
                                hoja.cell(row=69, column=col, value=motores).number_format = frmt
                                hoja.cell(row=70, column=col, value=medios_trasnporte).number_format = frmt
                                hoja.cell(row=71, column=col, value=combustible_mineria).number_format = frmt
                                hoja.cell(row=72, column=col, value=explosivos_mineria_kg).number_format = frmt
                                hoja.cell(row=73, column=col, value=explosivos_mineria_m).number_format = frmt
                                hoja.cell(row=74, column=col, value=explosivos_mineria_und).number_format = frmt
                                hoja.cell(row=75, column=col, value=coltan).number_format = frmt

                                hoja.cell(row=76, column=col, value=incautacion_muebles).number_format = frmt
                                hoja.cell(row=77, column=col, value=incautacion_inmuebles).number_format = frmt
                                hoja.cell(row=78, column=col, value=incautacion_vehiculos).number_format = frmt

                                hoja.cell(row=79, column=col, value=capturas_contrabando).number_format = frmt
                                hoja.cell(row=80, column=col, value=combustible_contrabando).number_format = frmt
                                hoja.cell(row=81, column=col, value=gasolina_contrabando).number_format = frmt
                                hoja.cell(row=82, column=col, value=acpm_contrabando).number_format = frmt
                                hoja.cell(row=83, column=col, value=vehiculos_contrando).number_format = frmt
                    ...
                    if col_merge_inicio > col_merge_final or  col_merge_inicio == col_merge_final:
                        # print( unidad_br)
                        col_merge_final = col_merge_final +1
                    else:
                        col_merge_final = col_merge_final -1
                    # print( unidad_br)
                    # print(col_merge_inicio)
                    # print(col_merge_final)
                     
                    try:
                        hoja.cell(row=1, column=columna, value=unidad_br) 
                        hoja.merge_cells(start_row=1, end_row=1, start_column=col_merge_inicio, end_column=col_merge_final)
                        
                    except:
                        print("An exception occurred " + unidad_br + " " + str(col_merge_final))
                        hoja.cell(row=1, column=columna, value=unidad_br) 

                    col_merge_inicio = col_merge_final + 1
                # print(div[0])
                
                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 0, "NO") #funcion para filtar el spoa
                numero_res =calculo(valor_calculado[0], div[0], 1, 18)
                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 1, "NO") #funcion para filtar el spoa
                numero_presentacion =calculo(valor_calculado[0], div[0], 1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 2, "NO") #funcion para filtar el spoa
                sometimientos =calculo(valor_calculado[0], div[0], 1, 18)
                ...
                capturas =calculo(valor_calculado[0], div[0], 1, 18)
                # print(capturas)
                # print(div[0])
                # print(filtro[16])

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 4, "SI") #funcion para filtar el spoa
                mdom =calculo(valor_calculado[0], div[0], 1, 18)

                                
                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 5, "SI") #funcion para filtar el spoa
                asesinados =calculo(valor_calculado[0], div[0], 1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 6, "SI") #funcion para filtar el spoa
                heridos =calculo(valor_calculado[0], div[0], 1, 18)


                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 7, "SI") #funcion para filtar el spoa
                largas =calculo(valor_calculado[0], div[0], 1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 8, "SI") #funcion para filtar el spoa
                cortas =calculo(valor_calculado[0], div[0], 1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 9, "SI") #funcion para filtar el spoa
                acompaniamiento =calculo(valor_calculado[0], div[0], 1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 10, "SI") #funcion para filtar el spoa
                municiones =calculo(valor_calculado[0], div[0], 1, 18)

                combates_pos = calculo(res_calculo[11],div[0],2, 14)
                combates_neg = calculo(res_calculo[12],div[0],2, 14)
                combates_sin_res = calculo(res_calculo[13],div[0],2, 14)
                combates  = calculo(res_calculo[14],div[0],2, 14)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 66, "SI") #funcion para filtar el spoa
                hostigamientos   = calculo(valor_calculado[0],div[0],1, 18)
                asonadas   = calculo(res_calculo[67],div[0],1, 18)


                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 21, "SI") #funcion para filtar el spoa
                cocaina = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 22, "SI") #funcion para filtar el spoa
                marihuna = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 23, "SI") #funcion para filtar el spoa
                pbc = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 69, "SI") #funcion para filtar el spoa
                heronia = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 68, "SI") #funcion para filtar el spoa
                basuco = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 70, "SI") #funcion para filtar el spoa
                drogas_sinteticas = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 24, "SI") #funcion para filtar el spoa
                lab_cocaina = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 25, "SI") #funcion para filtar el spoa
                lab_pbc = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 71, "SI") #funcion para filtar el spoa
                lab_heronina = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 26, "SI") #funcion para filtar el spoa
                semilleros = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 27, "SI") #funcion para filtar el spoa
                matas_semilleros = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 29, "SI") #funcion para filtar el spoa
                insumos_solidos = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 28, "SI") #funcion para filtar el spoa
                nsumos_liquidos = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 62, "SI") #funcion para filtar el spoa
                combustible_contrabando = calculo(valor_calculado[0],div[0],1, 18)

                                                
                neutralizacion_t = calculo(res_calculo[15],div[0],2, 14)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 80, "NO") #funcion para filtar el spoa
                artefacto_explosivo = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 16, "NO") #funcion para filtar el spoa
                ae = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 17, "NO") #funcion para filtar el spoa
                map = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 18, "NO") #funcion para filtar el spoa
                explosivos = calculo(valor_calculado[0],div[0],1, 18)
                                
                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 78, "NO") #funcion para filtar el spoa
                explosivos_m = calculo(valor_calculado[0],div[0],1, 18)
                                
                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 79, "NO") #funcion para filtar el spoa
                explosivos_und = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 19, "NO") #funcion para filtar el spoa
                cordon = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 20, "NO") #funcion para filtar el spoa
                mecha = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 72, "NO") #funcion para filtar el spoa
                medios_lanzamientos = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 73, "NO") #funcion para filtar el spoa
                detonadores_electricos = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 74, "NO") #funcion para filtar el spoa
                detonadores_anaelectricos = calculo(valor_calculado[0],div[0],1, 18)


                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 42, "SI") #funcion para filtar el spoa
                liberados = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 43, "SI") #funcion para filtar el spoa
                rescatados = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 44, "NO") #funcion para filtar el spoa
                valvulas = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 45, "NO") #funcion para filtar el spoa
                refinerias = calculo(valor_calculado[0],div[0],1, 18)


                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 86, "NO") #funcion para filtar el spoa
                oleoducto = calculo(valor_calculado[0],div[0],1, 18)
                                
                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 87, "NO") #funcion para filtar el spoa
                petroleo = calculo(valor_calculado[0],div[0],1, 18)
                                
                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 88, "NO") #funcion para filtar el spoa
                piscina = calculo(valor_calculado[0],div[0],1, 18)

 
                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 76, "NO") #funcion para filtar el spoa
                pesos = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 75, "NO") #funcion para filtar el spoa
                dolares = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 77, "NO") #funcion para filtar el spoa
                euros = calculo(valor_calculado[0],div[0],1, 18)


                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 30, "SI") #funcion para filtar el spoa          
                cap_amazonia = calculo(valor_calculado[0],div[0],1, 18)
                plantulas = calculo(res_calculo[31],div[0],1, 18)
                madera = calculo(res_calculo[32],div[0],1, 18)
                especies = calculo(res_calculo[63],div[0],1, 18)


                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 33, "SI") #funcion para filtar el spoa                 
                cap_menria = calculo(valor_calculado[0],div[0],1, 18)

                yacimiento_mineros = calculo(res_calculo[35],div[0],2, 14)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 40, "NO") #funcion para filtar el spoa 
                upm = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 38, "NO") #funcion para filtar el spoa 
                maquinaria_pesada = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 39, "NO") #funcion para filtar el spoa 
                tractor_con_oruga = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 36, "NO") #funcion para filtar el spoa 
                excavadoras = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 37, "NO") #funcion para filtar el spoa 
                retroexcavadoras = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 41, "NO") #funcion para filtar el spoa 
                dragas = calculo(valor_calculado[0],div[0],1, 18)

                                
                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 81, "NO") #funcion para filtar el spoa 
                maquinaria_amarilla = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 59, "NO") #funcion para filtar el spoa 
                motores = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 85, "NO") #funcion para filtar el spoa 
                medios_trasnporte = calculo(valor_calculado[0],div[0],1, 18)
                                
                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 60, "NO") #funcion para filtar el spoa 
                combustible_mineria = calculo(valor_calculado[0],div[0],1, 18)

                                                                
                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 82, "NO") #funcion para filtar el spoa 
                explosivos_mineria_kg = calculo(valor_calculado[0],div[0],1, 18)
                                                                
                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 83, "NO") #funcion para filtar el spoa 
                explosivos_mineria_m = calculo(valor_calculado[0],div[0],1, 18)
                                                                
                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 84, "NO") #funcion para filtar el spoa 
                explosivos_mineria_und = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 65, "NO") #funcion para filtar el spoa 
                coltan = calculo(valor_calculado[0],div[0],1, 18)


                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 91, "NO") #funcion para filtar el spoa 
                incautacion_muebles = calculo(valor_calculado[0],div[0],1, 18)
                                
                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 90, "NO") #funcion para filtar el spoa 
                incautacion_inmuebles = calculo(valor_calculado[0],div[0],1, 18)
                                
                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 92, "NO") #funcion para filtar el spoa 
                incautacion_vehiculos = calculo(valor_calculado[0],div[0],1, 18)

                                                                
                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 49, "NO") #funcion para filtar el spoa 
                capturas_contrabando = calculo(valor_calculado[0],div[0],1, 18)
                                                                
                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 62, "NO") #funcion para filtar el spoa 
                combustible_contrabando = calculo(valor_calculado[0],div[0],1, 18)
                                                                
                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 50, "NO") #funcion para filtar el spoa 
                gasolina_contrabando = calculo(valor_calculado[0],div[0],1, 18)
                                                                
                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 51, "NO") #funcion para filtar el spoa 
                acpm_contrabando = calculo(valor_calculado[0],div[0],1, 18)
                                                                
                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 53, "NO") #funcion para filtar el spoa 
                vehiculos_contrando = calculo(valor_calculado[0],div[0],1, 18)

                
                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 93, "NO") #funcion para filtar el spoa 
                afectacion_oleoducto = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 94, "NO") #funcion para filtar el spoa 
                apique = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 96, "NO") #funcion para filtar el spoa 
                aboyadura = calculo(valor_calculado[0],div[0],1, 18)
                
                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 95, "NO") #funcion para filtar el spoa 
                destruido = calculo(valor_calculado[0],div[0],1, 18)

                valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 97, "NO") #funcion para filtar el spoa 
                saboteado = calculo(valor_calculado[0],div[0],1, 18)

                # valor_calculado = Calculo_Spoa.validar_spoa_unidad(self, filtro, res_calculo, 98, "NO") #funcion para filtar el spoa 
                total_resultados = calculo(res_calculo[98],div[0],2, 14)
