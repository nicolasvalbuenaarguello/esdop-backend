...
from tipo_docker.y_i_resultados_excel.models.funtions.pdf.boletin_coe import *
#Funcion de resultados nueva ayuda

def excel_ut_excel(datos, link, ruta, puerto):


    nombre_carpeta = "excel_ut_excel{}/".format(puerto)
