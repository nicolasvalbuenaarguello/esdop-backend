...
from tipo_docker.b_c_boletin_comparativo_r.models.estadistica.estadistica_boletin_coe import *
...
#funcion para crear la estadistica resaltantes comparativos 
def boletin_comparativo_r(fecha_inicial_u_l, fecha_final_u_l, fecha_inicial_p_l, fecha_final_p_l, filtro, dirercion_archvios, nombre_carpeta):
    ...
    img_qr =  "C:/Users/nicolas.valbuena/Documents/programacion 2023/server/tipo_docker/b_c_boletin_comparativo_r/models/qr_img"
    ...
    resultados_spoa.resultados_resaltantes_r(pdf, fecha_inicial_u_l, fecha_final_u_l, fecha_inicial_p_l, fecha_final_p_l, filtro, fechas_final[2], fechas_inicial[2],fecha_titulo, fecha_titulo_dos)
