...
from tipo_docker.b_c_boletin_comparativo_r.models.funtions.pdf.boletin_coe import *
#Funcion de resultados nueva ayuda

def boletin_coe_reducido(datos, link, ruta, puerto):

    
    nombre_carpeta = "estadistica_consejos_reducido{}/".format(puerto)
    ...
    direcion = boletin_comparativo_r(fecha_primer_lapso_inicial, fecha_ultimo_lapso_inicial, fecha_primer_lapso_final, fecha_ultimo_lapso_final, filtros, dirercion_archvios, nombre_carpeta)
