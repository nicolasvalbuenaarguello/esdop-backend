...
from tipo_docker.b_f_resultados_lineas_estrategicas_paya.models.funtions.pdf.boletin_coe import *
#Funcion de resultados nueva ayuda

def res_linea_estrategica_narcotrafico(datos, link, ruta, puerto):


    nombre_carpeta = "res_linea_estrategica_narcotrafico{}/".format(puerto)
    ...
    direcion = comparativo_comparativo_mapa(fecha_primer_lapso_inicial, fecha_ultimo_lapso_inicial, fecha_primer_lapso_final, fecha_ultimo_lapso_final, filtros, dirercion_archvios, nombre_carpeta)
    dir = {
